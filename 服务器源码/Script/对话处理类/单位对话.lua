...
-- @Last Modified time: 2020-09-18 05:17:47
...
function 场景类_地图单位对话:地图单位对话(连接id,数字id,序列,标识,地图)
  ...
  elseif 类型==80000 then
    local 模型 =f函数.读配置(程序目录.."定制难度.ini","定制任务","模型1")
    local 物资1=f函数.读配置(程序目录.."定制难度.ini","定制任务","全服贡献物资")+0
    local 当前经验倍数1=f函数.读配置(程序目录.."定制难度.ini","定制任务","提升经验倍数")+0
    local 当前经验倍数=当前经验倍数1*100
    local 物资=math.floor(物资1/100000000)
    对话数据.对话 = "#G当全服捐献物资数量达到一定数额，就可以进行挑战经验掌控者 #S捐献:#R100亿#G全服经验倍数提升20% #S捐献:#R200亿#G全服经验倍数提升50% #S捐献:#R500亿#G全服经验倍数提升100% #S当前累积物资：#R"..物资.."亿 #S当前提升全服经验倍数：#R"..当前经验倍数.."% #S物资的10%作为奖励给与全服功臣，每晚7点领取！"
    对话数据.选项 = {"捐献1000万","捐献5000万","捐献1亿","捐献10亿","捐献100亿","领取物资奖励","查看当前累积物资"}
  end
