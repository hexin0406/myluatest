  ...
  elseif 类型==345 then
    if 事件=="我要挑战" then
      ...
      if 玩家数据[数字id].角色.数据.七十二地煞 < 任务数据[玩家数据[数字id].地图单位.标识].难度 then
        常规提示(数字id,"#Y你当前无法挑战此等级地煞,需要从低星地煞挑战上来，你当前可挑战"..(玩家数据[数字id].角色.数据.七十二地煞+1).."星的地煞星")
        return
      end
  ...
  elseif 类型==80000 then
        ...
        if  事件=="捐献1000万" then
          if 玩家数据[数字id].角色.数据.银子 < 10000000 then
            常规提示(数字id,"#Y你携带的银币不够本次捐献")
            return
          end
            物资2=物资1+10000000
            玩家数据[数字id].角色:扣除银子(10000000,0,0,"捐献1000万",1)
            f函数.写配置(程序目录..[[定制难度.ini]],"定制任务","全服贡献物资",物资2)
            玩家数据[数字id].角色.数据.累积捐献物资=玩家数据[数字id].角色.数据.累积捐献物资+10000000
            常规提示(数字id,"#Y成功捐献1000万物资，你的累积捐献物资为:"..(玩家数据[数字id].角色.数据.累积捐献物资/100000000).."亿")
        end
        if  事件=="捐献5000万" then
          if 玩家数据[数字id].角色.数据.银子 < 50000000 then
            常规提示(数字id,"#Y你携带的银币不够本次捐献")
            return
          end
              物资2=物资1+50000000
              玩家数据[数字id].角色:扣除银子(50000000,0,0,"捐献5000万",1)
              f函数.写配置(程序目录..[[定制难度.ini]],"定制任务","全服贡献物资",物资2)
              玩家数据[数字id].角色.数据.累积捐献物资=玩家数据[数字id].角色.数据.累积捐献物资+50000000
              常规提示(数字id,"#Y成功捐献5000万物资，你的累积捐献物资为:"..(玩家数据[数字id].角色.数据.累积捐献物资/100000000).."亿")
        end
        if  事件=="捐献1亿" then
          if 玩家数据[数字id].角色.数据.银子 < 100000000 then
            ...
            物资2=物资1+100000000
            玩家数据[数字id].角色:扣除银子(100000000,0,0,"捐献1亿",1)
            f函数.写配置(程序目录..[[定制难度.ini]],"定制任务","全服贡献物资",物资2)
            玩家数据[数字id].角色.数据.累积捐献物资=玩家数据[数字id].角色.数据.累积捐献物资+100000000
            常规提示(数字id,"#Y成功捐献1亿物资，你的累积捐献物资为:"..(玩家数据[数字id].角色.数据.累积捐献物资/100000000).."亿")
        end
        if  事件=="捐献10亿" then
          if 玩家数据[数字id].角色.数据.银子 < 1000000000 then
            ...
            物资2=物资1+1000000000
            玩家数据[数字id].角色:扣除银子(1000000000,0,0,"捐献10亿",1)
            f函数.写配置(程序目录..[[定制难度.ini]],"定制任务","全服贡献物资",物资2)
            玩家数据[数字id].角色.数据.累积捐献物资=玩家数据[数字id].角色.数据.累积捐献物资+1000000000
            常规提示(数字id,"#Y成功捐献10亿物资，你的累积捐献物资为:"..(玩家数据[数字id].角色.数据.累积捐献物资/100000000).."亿")
        end
        if  事件=="捐献100亿" then
          if 玩家数据[数字id].角色.数据.银子 < 10000000000 then
            常规提示(数字id,"#Y你携带的银币不够本次捐献")
            return
          end
            物资2=物资1+10000000000
            玩家数据[数字id].角色:扣除银子(10000000000,0,0,"捐献100亿",1)
            f函数.写配置(程序目录..[[定制难度.ini]],"定制任务","全服贡献物资",物资2)
            玩家数据[数字id].角色.数据.累积捐献物资=玩家数据[数字id].角色.数据.累积捐献物资+10000000000
            常规提示(数字id,"#Y成功捐献100亿物资，你的累积捐献物资为:"..(玩家数据[数字id].角色.数据.累积捐献物资/100000000).."亿")
        end
        if  事件=="领取物资奖励" then
          local 小时数=os.date("%H", os.time())
          if 小时数=="19" then
            if 领取人名字==名称1 then
              if 领取1==0 then
               领取物资=(物资1/未领取物资人数)/50
        ...
        if  事件=="查看当前累积物资" then
            local aa="#S你的当前累计物资为：#R"..(玩家数据[数字id].角色.数据.累积捐献物资/100000000).."亿"
