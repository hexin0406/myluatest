	...
	if self:取是否有帮派(id) then
		...
		if 玩家数据[玩家id] == nil then
			...
			if 事件 == "帮主" then
				...
				for n=1,#玩家数据[玩家id].角色.数据.称谓 do
					if 玩家数据[玩家id].角色.数据.称谓[n]=="盖世英豪" then
					    玩家数据[玩家id].角色:删除称谓(玩家id,"盖世英豪")
					end
					if	玩家数据[玩家id].角色.数据.称谓[n]=="战神" then
				        玩家数据[玩家id].角色:删除称谓(玩家id,"战神")
				    end
				    if	玩家数据[玩家id].角色.数据.称谓[n]=="九五之尊" then
						玩家数据[玩家id].角色:删除称谓(玩家id,"九五之尊")
					end
				end
