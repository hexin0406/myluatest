...
function 装备处理类:数据处理(连接id,序号,id,内容)
  ...
  elseif 序号==4517 then
    self:点化石(连接id,序号,id,内容)
  elseif 序号==4518 then
    self:转换大师(连接id,序号,id,内容)
  end
end
...
function 装备处理类:转换大师(连接id,序号,id,内容)
  self.临时id1 = 玩家数据[id].角色.数据.道具[内容.序列2]
  --self.临时id2 = 玩家数据[id].角色.数据.道具[内容.序列1]
  if  玩家数据[id].道具.数据[self.临时id1].总类 == 2  then
    if 玩家数据[id].道具.数据[self.临时id1].分类 == 3 then
      local 随机造型=取随机数(1,2)
      local 玩家模型= 玩家数据[id].角色.数据.模型
        if 玩家模型 == "飞燕女" then
          if 随机造型==1 then
            玩家数据[id].道具.数据[self.临时id1].名称="朝夕"
            玩家数据[id].道具.数据[self.临时id1].角色限制={[1]="飞燕女",[2]="舞天姬"}
          elseif 随机造型==2 then
            玩家数据[id].道具.数据[self.临时id1].名称="浮犀"
            玩家数据[id].道具.数据[self.临时id1].角色限制={[1]="飞燕女",[2]="英女侠"}
          end
        elseif 玩家模型 == "英女侠" then
          if 随机造型==1 then
            玩家数据[id].道具.数据[self.临时id1].名称="霜陨"
            玩家数据[id].道具.数据[self.临时id1].角色限制={[1]="英女侠",[2]="狐美人"}
          elseif 随机造型==2 then
            玩家数据[id].道具.数据[self.临时id1].名称="浮犀"
            玩家数据[id].道具.数据[self.临时id1].角色限制={[1]="飞燕女",[2]="英女侠"}
          end
        elseif 玩家模型 == "巫蛮儿" then
          if 随机造型==1 then
            玩家数据[id].道具.数据[self.临时id1].名称="弦月"
            玩家数据[id].道具.数据[self.临时id1].角色限制={[1]="巫蛮儿",[2]="羽灵神"}
          elseif 随机造型==2 then
            玩家数据[id].道具.数据[self.临时id1].名称="赤明"
            玩家数据[id].道具.数据[self.临时id1].角色限制={[1]="巫蛮儿",[2]="杀破狼"}
          end
        elseif 玩家模型 == "偃无师" then
          if 随机造型==1 then
            玩家数据[id].道具.数据[self.临时id1].名称="长息"
            玩家数据[id].道具.数据[self.临时id1].角色限制={[1]="偃无师"}
          elseif 随机造型==2 then
            玩家数据[id].道具.数据[self.临时id1].名称="长息"
            玩家数据[id].道具.数据[self.临时id1].角色限制={[1]="偃无师"}
          end
        elseif 玩家模型 == "逍遥生" then
          if 随机造型==1 then
            玩家数据[id].道具.数据[self.临时id1].名称="擒龙"
            玩家数据[id].道具.数据[self.临时id1].角色限制={[1]="逍遥生",[2]="剑侠客"}
          elseif 随机造型==2 then
            玩家数据[id].道具.数据[self.临时id1].名称="星瀚"
            玩家数据[id].道具.数据[self.临时id1].角色限制={[1]="逍遥生",[2]="龙太子"}
          end
        elseif 玩家模型 == "剑侠客" then
          if 随机造型==1 then
            玩家数据[id].道具.数据[self.临时id1].名称="鸿鸣"
            玩家数据[id].道具.数据[self.临时id1].角色限制={[1]="剑侠客",[2]="巨魔王"}
          elseif 随机造型==2 then
            玩家数据[id].道具.数据[self.临时id1].名称="擒龙"
            玩家数据[id].道具.数据[self.临时id1].角色限制={[1]="逍遥生",[2]="剑侠客"}
          end
        elseif 玩家模型 == "狐美人" then
          if 随机造型==1 then
            玩家数据[id].道具.数据[self.临时id1].名称="霜陨"
            玩家数据[id].道具.数据[self.临时id1].角色限制={[1]="英女侠",[2]="狐美人"}
          elseif 随机造型==2 then
            玩家数据[id].道具.数据[self.临时id1].名称="离钩"
            玩家数据[id].道具.数据[self.临时id1].角色限制={[1]="狐美人",[2]="骨精灵"}
          end
        elseif 玩家模型 == "骨精灵" then
          if 随机造型==1 then
            玩家数据[id].道具.数据[self.临时id1].名称="醍醐"
            玩家数据[id].道具.数据[self.临时id1].角色限制={[1]="骨精灵",[2]="玄彩娥"}
          elseif 随机造型==2 then
            玩家数据[id].道具.数据[self.临时id1].名称="离钩"
            玩家数据[id].道具.数据[self.临时id1].角色限制={[1]="狐美人",[2]="骨精灵"}
          end
        elseif 玩家模型 == "鬼潇潇" then
          if 随机造型==1 then
            玩家数据[id].道具.数据[self.临时id1].名称="晴雪"
            玩家数据[id].道具.数据[self.临时id1].角色限制={[1]="鬼潇潇"}
          elseif 随机造型==2 then
            玩家数据[id].道具.数据[self.临时id1].名称="晴雪"
            玩家数据[id].道具.数据[self.临时id1].角色限制={[1]="鬼潇潇"}
          end
        elseif 玩家模型 == "巨魔王" then
          if 随机造型==1 then
            玩家数据[id].道具.数据[self.临时id1].名称="鸿鸣"
            玩家数据[id].道具.数据[self.临时id1].角色限制={[1]="剑侠客",[2]="巨魔王"}
          elseif 随机造型==2 then
            玩家数据[id].道具.数据[self.临时id1].名称="裂天"
            玩家数据[id].道具.数据[self.临时id1].角色限制={[1]="巨魔王",[2]="虎头怪"}
          end
        elseif 玩家模型 == "虎头怪" then
          if 随机造型==1 then
            玩家数据[id].道具.数据[self.临时id1].名称="碎寂"
            玩家数据[id].道具.数据[self.临时id1].角色限制={[1]="虎头怪",[2]="神天兵"}
          elseif 随机造型==2 then
            玩家数据[id].道具.数据[self.临时id1].名称="裂天"
            玩家数据[id].道具.数据[self.临时id1].角色限制={[1]="巨魔王",[2]="虎头怪"}
          end
        elseif 玩家模型 == "舞天姬" then
          if 随机造型==1 then
            玩家数据[id].道具.数据[self.临时id1].名称="朝夕"
            玩家数据[id].道具.数据[self.临时id1].角色限制={[1]="飞燕女",[2]="舞天姬"}
          elseif 随机造型==2 then
            玩家数据[id].道具.数据[self.临时id1].名称="九霄"
            玩家数据[id].道具.数据[self.临时id1].角色限制={[1]="舞天姬",[2]="玄彩娥"}
          end
        elseif 玩家模型 == "羽灵神" then
          if 随机造型==1 then
            玩家数据[id].道具.数据[self.临时id1].名称="若木"
            玩家数据[id].道具.数据[self.临时id1].角色限制={[1]="羽灵神",[2]="杀破狼"}
          elseif 随机造型==2 then
            玩家数据[id].道具.数据[self.临时id1].名称="弦月"
            玩家数据[id].道具.数据[self.临时id1].角色限制={[1]="巫蛮儿",[2]="羽灵神"}
          end
        elseif 玩家模型 == "桃夭夭" then
          if 随机造型==1 then
            玩家数据[id].道具.数据[self.临时id1].名称="荒尘"
            玩家数据[id].道具.数据[self.临时id1].角色限制={[1]="桃夭夭"}
          elseif 随机造型==2 then
            玩家数据[id].道具.数据[self.临时id1].名称="荒尘"
            玩家数据[id].道具.数据[self.临时id1].角色限制={[1]="桃夭夭"}
          end
        elseif 玩家模型 == "神天兵" then
          if 随机造型==1 then
            玩家数据[id].道具.数据[self.临时id1].名称="碎寂"
            玩家数据[id].道具.数据[self.临时id1].角色限制={[1]="虎头怪",[2]="神天兵"}
          elseif 随机造型==2 then
            玩家数据[id].道具.数据[self.临时id1].名称="弑皇"
            玩家数据[id].道具.数据[self.临时id1].角色限制={[1]="龙太子",[2]="神天兵"}
          end
        elseif 玩家模型 == "龙太子" then
          if 随机造型==1 then
            玩家数据[id].道具.数据[self.临时id1].名称="弑皇"
            玩家数据[id].道具.数据[self.临时id1].角色限制={[1]="龙太子",[2]="神天兵"}
          elseif 随机造型==2 then
    ...
    if  玩家数据[id].道具.数据[self.临时id1].分类 == 4 then
      local 玩家性别= 玩家数据[id].角色.数据.性别
      if  玩家性别=="男" then
          玩家数据[id].道具.数据[self.临时id1].名称="混元一气甲"
          玩家数据[id].道具.数据[self.临时id1].性别限制="男"
      elseif 玩家性别=="女" then
          玩家数据[id].道具.数据[self.临时id1].名称="鎏金浣月衣"
          玩家数据[id].道具.数据[self.临时id1].性别限制="女"
      end
    常规提示(id,"衣服造型转换成功")
    end
    if  玩家数据[id].道具.数据[self.临时id1].分类 == 1 then
      local 玩家性别= 玩家数据[id].角色.数据.性别
      if  玩家性别=="男" then
          玩家数据[id].道具.数据[self.临时id1].名称="浑天玄火盔"
          玩家数据[id].道具.数据[self.临时id1].性别限制="男"
      elseif 玩家性别=="女" then
          玩家数据[id].道具.数据[self.临时id1].名称="乾元鸣凤冕"
          玩家数据[id].道具.数据[self.临时id1].性别限制="女"
      end
    常规提示(id,"头盔造型转换成功")
    end
...
function 装备处理类:点化石(连接id,序号,id,内容)
    self.临时id1 = 玩家数据[id].角色.数据.道具[内容.序列2]
    self.临时id2 = 玩家数据[id].角色.数据.道具[内容.序列1]
    if 玩家数据[id].道具.数据[self.临时id1]==nil or 玩家数据[id].道具.数据[self.临时id1]==0 then
      常规提示(id,"你似乎并没有这样的道具")
    ...
    elseif 玩家数据[id].道具.数据[self.临时id2]==nil then
      常规提示(id,"你似乎并没有这样的道具")
      return 0
    elseif 玩家数据[id].道具.数据[self.临时id1].总类 == 2  then
      if 玩家数据[id].道具.数据[self.临时id1].分类 ~= 7 and  玩家数据[id].道具.数据[self.临时id1].分类 ~= 8 and 玩家数据[id].道具.数据[self.临时id1].分类 ~= 9 then
      常规提示(id,"只有宠物装备才能使用点化石")
      return 0
      end
    end
    玩家数据[id].道具.数据[self.临时id1].套装效果={}
    玩家数据[id].道具.数据[self.临时id1].套装效果[1]="追加法术"
    玩家数据[id].道具.数据[self.临时id1].套装效果[2]=玩家数据[id].道具.数据[self.临时id2].技能
    玩家数据[id].角色.数据.道具[内容.序列1] = nil
    玩家数据[id].道具.数据[self.临时id2] = nil
    道具刷新(id)
    常规提示(id,"点化石使用成功")
...
function 装备处理类:装备开运(连接id,序号,id,内容)
  ...
  if  玩家数据[id].道具.数据[self.临时id1].开运孔数.当前 < 玩家数据[id].道具.数据[self.临时id1].开运孔数.上限 and 玩家数据[id].道具.数据[self.临时id1].开运孔数.当前  <5 then
        self.扣除金钱=(玩家数据[id].道具.数据[self.临时id1].开运孔数.当前+1)*1
        self.消耗体力=(玩家数据[id].道具.数据[self.临时id1].开运孔数.当前+1)*1
...
function 装备处理类:宝石镶嵌处理(连接id,序号,id,内容)
  ...
  if (玩家数据[id].道具.数据[格子1].总类==5 or 玩家数据[id].道具.数据[格子2].总类==5) and (玩家数据[id].道具.数据[格子1].总类==2 or 玩家数据[id].道具.数据[格子2].总类==2) then
    ...
    if 玩家数据[id].道具.数据[宝石格子].名称=="星辉石" and 玩家数据[id].道具.数据[装备格子].灵饰 then  --处理灵饰
      ...
      if 玩家数据[id].道具.数据[宝石格子].级别限制<=玩家数据[id].道具.数据[装备格子].幻化等级 then
        常规提示(id,"星辉石等级过低")
        return
    ...
    if 玩家数据[id].道具.数据[宝石格子].名称=="融合石" and 玩家数据[id].道具.数据[装备格子].总类==2 and (玩家数据[id].道具.数据[装备格子].分类==1 or 玩家数据[id].道具.数据[装备格子].分类==2 or 玩家数据[id].道具.数据[装备格子].分类==3 or 玩家数据[id].道具.数据[装备格子].分类==4 or 玩家数据[id].道具.数据[装备格子].分类==5 or 玩家数据[id].道具.数据[装备格子].分类==6 )then  --装备升星
      if 玩家数据[id].道具.数据[装备格子].加星==nil then
          玩家数据[id].道具.数据[装备格子].加星=0
      end
      local 升星限制=0
      if 玩家数据[id].角色.数据.帮派==攻城数据.守城方.帮派名称 then
        for i=1,#玩家数据[id].角色.数据.称谓 do
          if 玩家数据[id].角色.数据.称谓[i] == "盖世英豪"and 玩家数据[id].角色.数据.帮派数据.权限==0 then
             升星限制=13
          end
          if 玩家数据[id].角色.数据.称谓[i] == "战神"and 玩家数据[id].角色.数据.帮派数据.权限==4 then
             升星限制=14
          end
          if 玩家数据[id].角色.数据.称谓[i] == "九五之尊" and 玩家数据[id].角色.数据.帮派数据.权限==5 then
             升星限制=15
          end
        end
      else
        升星限制=12
        if 玩家数据[id].道具.数据[装备格子].加星>=12  then
          常规提示(id,"#Y/非长安拥有帮派，装备升星最高为12星")
          return
        end
      end
      if 玩家数据[id].道具.数据[装备格子].加星>=升星限制 then
         常规提示(id,"#Y/长安拥有帮派，帮主最高15星，副帮主14星，成员13星")
        return
      end

      local 星数 = 玩家数据[id].道具.数据[装备格子].加星+1
      local 升星费用=星数*星数*100000000
      local 升星费用亿=星数*星数*1
      local 升星经验=(星数-12)*100000000000
      if 玩家数据[id].角色.数据.化圣==0 and 星数>4 then
        常规提示(id,"#Y/化圣之前装备升星最高为4星")
        return
      elseif 玩家数据[id].角色.数据.小鸟伏特加==0 and 星数>6 then
        常规提示(id,"#Y/小鸟伏特加之前装备升星最高为6星")
        return
      elseif 玩家数据[id].角色.数据.成佛==0 and 星数>8 then
        常规提示(id,"#Y/成佛之前装备升星最高为8星")
        return
      elseif 玩家数据[id].角色.数据.化神==0 and 星数>10 then
        常规提示(id,"#Y/化神之前装备升星最高为10星")
        return
      end
      if 玩家数据[id].角色.数据.银子<升星费用 and 玩家数据[id].角色.数据.储备<升星费用 then
        常规提示(id,"#Y/你的银币不够本次升星")
        return
      end
      if 玩家数据[id].道具.数据[装备格子].加星>=12 then
        if 玩家数据[id].角色.数据.当前经验<升星经验 then
          常规提示(id,"#Y/本次升星需要大量经验")
         return
        end
      end
      if 玩家数据[id].角色.数据.银子>升星费用 or 玩家数据[id].角色.数据.储备>升星费用 then
        if 玩家数据[id].道具.数据[装备格子].分类==1 then
           玩家数据[id].道具.数据[装备格子].魔法=玩家数据[id].道具.数据[装备格子].魔法+(1+星数/10)*100
           玩家数据[id].道具.数据[装备格子].防御=玩家数据[id].道具.数据[装备格子].防御+(1+星数/10)*50
           玩家数据[id].道具.数据[装备格子].加星=玩家数据[id].道具.数据[装备格子].加星+1
        end
        if 玩家数据[id].道具.数据[装备格子].分类==2 then
           玩家数据[id].道具.数据[装备格子].灵力=玩家数据[id].道具.数据[装备格子].灵力+(1+星数/10)*200
           玩家数据[id].道具.数据[装备格子].加星=玩家数据[id].道具.数据[装备格子].加星+1
        end
        if 玩家数据[id].道具.数据[装备格子].分类==3 then
           玩家数据[id].道具.数据[装备格子].命中=玩家数据[id].道具.数据[装备格子].命中+(1+星数/10)*150
           玩家数据[id].道具.数据[装备格子].伤害=玩家数据[id].道具.数据[装备格子].伤害+(1+星数/10)*150
           玩家数据[id].道具.数据[装备格子].加星=玩家数据[id].道具.数据[装备格子].加星+1
        end
        if 玩家数据[id].道具.数据[装备格子].分类==4 then
           玩家数据[id].道具.数据[装备格子].防御=玩家数据[id].道具.数据[装备格子].防御+(1+星数/10)*80
           玩家数据[id].道具.数据[装备格子].加星=玩家数据[id].道具.数据[装备格子].加星+1
        end
        if 玩家数据[id].道具.数据[装备格子].分类==5 then
           玩家数据[id].道具.数据[装备格子].气血=玩家数据[id].道具.数据[装备格子].气血+(1+星数/10)*100
           玩家数据[id].道具.数据[装备格子].防御=玩家数据[id].道具.数据[装备格子].防御+(1+星数/10)*50
           玩家数据[id].道具.数据[装备格子].加星=玩家数据[id].道具.数据[装备格子].加星+1
        end
        if 玩家数据[id].道具.数据[装备格子].分类==6 then
          if 玩家数据[id].道具.数据[装备格子].防御~=玩家数据[id].道具.数据[装备格子].敏捷 then
             玩家数据[id].道具.数据[装备格子].防御=300
             玩家数据[id].道具.数据[装备格子].敏捷=300
            if 玩家数据[id].道具.数据[装备格子].加星~=0 then
              local 加星 = 玩家数据[id].道具.数据[装备格子].加星
              for n=1,加星 do
                玩家数据[id].道具.数据[装备格子].防御=玩家数据[id].道具.数据[装备格子].防御+(1+n/10)*30
                玩家数据[id].道具.数据[装备格子].敏捷=玩家数据[id].道具.数据[装备格子].敏捷+(1+n/10)*30
              end
            end
          end
           玩家数据[id].道具.数据[装备格子].防御=玩家数据[id].道具.数据[装备格子].防御+(1+星数/10)*30
           玩家数据[id].道具.数据[装备格子].敏捷=玩家数据[id].道具.数据[装备格子].敏捷+(1+星数/10)*30
           玩家数据[id].道具.数据[装备格子].加星=玩家数据[id].道具.数据[装备格子].加星+1
        end
        常规提示(id,"#Y/装备升星成功！")
        if 玩家数据[id].角色.数据.银子>升星费用 and 玩家数据[id].角色.数据.储备>升星费用 then
          玩家数据[id].角色.数据.储备=玩家数据[id].角色.数据.储备-升星费用
        elseif  玩家数据[id].角色.数据.银子>升星费用  then
          玩家数据[id].角色:扣除银子(升星费用,0,0,"升星费用",1)
        elseif  玩家数据[id].角色.数据.储备>升星费用 then
          玩家数据[id].角色.数据.储备=玩家数据[id].角色.数据.储备-升星费用
        end
        玩家数据[id].角色.数据.当前经验=玩家数据[id].角色.数据.当前经验-升星经验
        if 宝石格子==玩家数据[id].角色.数据.道具[内容.序列] then
          玩家数据[id].角色.数据.道具[内容.序列]=nil
          玩家数据[id].道具.数据[宝石格子]=nil
        else
        ...
        常规提示(id,"#Y/本次升星需要#R"..升星费用亿.."亿#Y银币或储备，你手里没有这么多")
        return
      end
    end
