...
-- @Last Modified time: 2020-09-21 05:43:36
...
变身卡数据={
	...
	,吸血鬼={技能="高级偷袭",属性=5,类型="速度",正负=1,等级=8}
	,鬼将={技能="高级必杀",属性=10,类型="伤害",正负=1,等级=8}
	,净瓶女娲={技能="高级永恒",属性=5,类型="防御",正负=1,等级=8}
	,律法女娲={技能="高级连击",属性=10,类型="伤害",正负=1,等级=8}
	,灵符女娲={技能="高级魔之心",属性=0,类型="气血",正负=1,等级=8}
	,大力金刚={技能="高级魔之心",属性=5,类型="灵力",正负=1,等级=8}
	,雾中仙={技能="高级敏捷",属性=10,类型="防御",正负=1,等级=8}
	,灵鹤={技能="高级法术暴击",属性=10,类型="灵力",正负=1,等级=8}
	,炎魔神={技能="高级魔之心",属性=15,类型="气血",正负=1,等级=8}
	,夜罗刹={技能="高级夜战",属性=5,类型="速度",正负=1,等级=8}
	,噬天虎={技能="高级强力",属性=10,类型="速度",正负=1,等级=8}
