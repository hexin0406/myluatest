...
function 坐骑资料库:坐骑库(id,zq,sp,sp2)
	...
	elseif id == "龙太子" then
		scs = {{0x4F27A59F,0x801F438D,"shape.wd5"},{0x46F4FDF6,0xC9EF2751,"shape.wd5"},{0x5B0EDDAD,0xB227D39F,"shape.wd5"},{0x643F7DDE,0xCC8E0921,"shape.wd5"},{0x00000002,0x00000003,"shape.wd5"}}
	end
	local bh = zqs[zq][3]
