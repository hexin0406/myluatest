...
function 任务处理类:完成门派任务(id,类型,双倍)
  ...
  local 基础经验=qz(等级*40000)
  local 基础银子=qz(等级*10000)
...
function 任务处理类:完成游泳任务(id)
  ...
  for n=1,#队伍数据[队伍id].成员数据 do
    if 队伍处理类:取是否助战(玩家数据[id].队伍,n) == 0 then
      local 临时id=队伍数据[队伍id].成员数据[n]
      local 经验=qz((等级*20000)*(1+任务数据[任务id].序列*0.1))
      local 银子=qz(等级*5000)
      ...
      elseif 奖励参数<=70 then
        local 名称="怪物卡片"
        玩家数据[临时id].道具:给予道具(临时id,名称,取随机数(5,8))
        常规提示(临时id,"#Y/你获得了"..名称)
        广播消息({内容=format("#S(游泳比赛)#R/%s#Y经过一番激烈的战斗，最终战胜了#R%s#Y，因此获得了其奖励的#G/%s#Y".."#"..取随机数(1,110),玩家数据[临时id].角色.数据.名称,"游泳试练官员",名称),频道="xt"})
      elseif 奖励参数<=71 then
        玩家数据[临时id].角色:添加元宝(1,"捣乱的水果",1)
        常规提示(临时id,"#Y/你获得了1元宝")
        广播消息({内容=format("#S(游泳比赛)#Y/经过一番激烈的战斗，玩家：#R"..玩家数据[临时id].角色.数据.名称.."#Y获得了#R1元宝")})
      end
      if 任务数据[任务id].序列==20 then
        ...
        if 活跃数据[临时id].游泳次数==nil then
          活跃数据[临时id].游泳次数=1
        end
        if 活跃数据[临时id].游泳次数>0 then
          玩家数据[临时id].角色:添加活跃度(30,"有用",1)
...
function 任务处理类:开启七十二地煞星任务()
  ...
  广播消息({内容=format("#S(七十二地煞星)#Y带着天界宝物已经出现在#Y%s，%s，%s，%s，%s，%s，%s，%s，%s，%s，%s，%s，%s#G场景内。听说挑战成功后会获得不菲的奖励哟，少侠敢来挑战么？".."#"..取随机数(1,110),地煞显示地图[1],地煞显示地图[2],地煞显示地图[3],地煞显示地图[4],地煞显示地图[5],地煞显示地图[6],地煞显示地图[7],地煞显示地图[8],地煞显示地图[9],地煞显示地图[10],地煞显示地图[11],地煞显示地图[12],地煞显示地图[13]),频道="xt"})
end
...
function 任务处理类:开启天罡星任务(id)
  ...
  广播消息({内容=format("#S(天罡星)#W带着天界宝物已经出现在#Y%s，%s，%s，%s，%s，%s，%s，%s，%s，%s，%s，%s#G场景内。帮助智勇双全的强者提升和检验其自身的修为，挑战成功的勇士还可以获得星君们赠予的宝物，少侠敢来挑战么？".."#"..取随机数(1,110),天罡显示地图[1],天罡显示地图[2],天罡显示地图[3],天罡显示地图[4],天罡显示地图[5],天罡显示地图[6],天罡显示地图[7],天罡显示地图[8],天罡显示地图[9],天罡显示地图[10],天罡显示地图[11],天罡显示地图[12]),频道="xt"})
end
  ...
  for n=1,#id组 do
    ...
    if 队伍处理类:取是否助战(玩家数据[id].队伍,n) == 0 then
      ...
      if 活跃数据[id].天罡星次数>0 then
        玩家数据[id].角色:添加活跃度(20,"天罡星",1)
        活跃数据[id].天罡星次数=活跃数据[id].天罡星次数-1
      end
      if 玩家数据[id].角色.数据.参战信息~=nil then
        玩家数据[id].召唤兽:获得经验(玩家数据[id].角色.数据.参战宝宝.认证码,math.floor(经验*0.8),id,"天罡星")
      end
      玩家数据[id].角色:添加元宝(3,"天罡星",1)
      常规提示(id,"#Y/你获得了3元宝")
      广播消息({内容=format("#S(天罡星)#Y/经过一番激烈的战斗，玩家：#R"..玩家数据[id].角色.数据.名称.."#Y获得了#R3元宝")})
    end
  end
  地图处理类:删除单位(任务数据[任务id].地图编号,任务数据[任务id].单位编号)
  任务数据[任务id]=nil
  ...
  for n=1,#队伍数据[队伍id].成员数据 do
    if 队伍处理类:取是否助战(玩家数据[数字id].队伍,n) == 0 then
      ...
      if 活跃数据[id].镖王次数>0 then
        玩家数据[id].角色:添加活跃度(30,"镖王",1)
        活跃数据[id].镖王次数=活跃数据[id].镖王次数-1
      end
      if 难度=="普通" then
          玩家数据[id].角色:添加元宝(3,"镖王",1)
          常规提示(id,"#Y/你获得了3元宝")
          广播消息({内容=format("#S(普通镖王活动)#Y/经过一番激烈的战斗，玩家：#R"..玩家数据[id].角色.数据.名称.."#Y获得了#R3元宝")})
      elseif 难度=="高级"  then
        玩家数据[id].角色:添加元宝(5,"镖王",1)
        常规提示(id,"#Y/你获得了5元宝")
        广播消息({内容=format("#S(高级镖王活动)#Y/经过一番激烈的战斗，玩家：#R"..玩家数据[id].角色.数据.名称.."#Y获得了#R5元宝")})
      elseif 难度 == "珍贵" then
        玩家数据[id].角色:添加元宝(8,"镖王",1)
        常规提示(id,"#Y/你获得了8元宝")
        广播消息({内容=format("#S(珍贵镖王活动)#Y/经过一番激烈的战斗，玩家：#R"..玩家数据[id].角色.数据.名称.."#Y获得了#R8元宝")})
      end
    end
  end
end
...
function 任务处理类:刷出知了王()
  ...
  广播消息({内容=format("#S/(知了王)#W/出现在#R/%s#W/处捣乱，快去降服",取地图名称(地图)),频道="xt"})
end
...
function 任务处理类:刷出知了先锋()
  ...
  广播消息({内容=format("#S/(知了先锋)#W/出现在#R/%s#W/处捣乱，快去降服",取地图名称(地图)),频道="xt"})
end
...
function 任务处理类:完成知了先锋任务(任务id,id组)
  ...
  for n=1,#id组 do
    ...
    if 队伍处理类:取是否助战(玩家数据[id].队伍,n) == 0 then
      ...
      elseif 奖励参数<=30 then
        local 名称=取宝石()
        玩家数据[id].道具:给予道具(id,名称,取随机数(12,14))
        常规提示(id,"#Y/你获得了"..名称)
        广播消息({内容=format("#S(知了先锋)#R/%s#Y经过一番激烈的战斗，最终战胜了#R%s#Y，因此获得了其奖励的#G/%s#Y".."#"..取随机数(1,110),玩家数据[id].角色.数据.名称,任务数据[任务id].名称,名称),频道="xt"})
      elseif 奖励参数<=45 then
        local 名称="初级神魂丹"
      ...
      elseif 奖励参数<=60 then
        ...
        广播消息({内容=format("#S(知了先锋)#R/%s#Y经过一番激烈的战斗，最终战胜了#R%s#Y，因此获得了其奖励的#G/%s#Y".."#"..取随机数(1,110),玩家数据[id].角色.数据.名称,任务数据[任务id].名称,名称),频道="xt"})
      elseif 奖励参数<=62 then
        玩家数据[id].角色:添加元宝(1,"知了先锋",1)
        常规提示(id,"#Y/你获得了1元宝")
        广播消息({内容=format("#S(知了先锋)#Y/经过一番激烈的战斗，玩家：#R"..玩家数据[id].角色.数据.名称.."#Y获得了#R1元宝")})
      end
    end
  end
  地图处理类:删除单位(任务数据[任务id].地图编号,任务数据[任务id].单位编号)
...
function 任务处理类:刷出小知了王()
  ...
  广播消息({内容=format("#S/(小知了王)#W/出现在#R/%s#W/处捣乱，快去降服",取地图名称(地图)),频道="xt"})
end
...
function 任务处理类:刷出王者荣耀()
  ...
  广播消息({内容=format("#S/(倔强青铜)出现在#R/%s#W/，大家快去降服",取地图名称(地图)),频道="xt"})
  地图=地图范围[取随机数(1,#地图范围)]
  for i=1,8 do
  ...
  广播消息({内容=format("#S/(秩序白银)出现在#R/%s#W/，大家快去降服",取地图名称(地图)),频道="xt"})
  地图=地图范围[取随机数(1,#地图范围)]
  for i=1,6 do
  ...
  广播消息({内容=format("#S/(荣耀黄金)出现在#R/%s#W/，大家快去降服",取地图名称(地图)),频道="xt"})
  地图=地图范围[取随机数(1,#地图范围)]
  for i=1,4 do
  ...
  广播消息({内容=format("#S/(永恒钻石)出现在#R/%s#W/，大家快去降服",取地图名称(地图)),频道="xt"})
  地图=地图范围[取随机数(1,#地图范围)]
  for i=1,2 do
  ...
  广播消息({内容=format("#S/(至尊星耀)出现在#R/%s#W/，大家快去降服",取地图名称(地图)),频道="xt"})
  地图=地图范围[取随机数(1,#地图范围)]
  for i=1,1 do
  ...
  广播消息({内容=format("#S/(最强王者)出现在#R/%s#W/，大家快去降服",取地图名称(地图)),频道="xt"})
end
  ...
  for n=1,#id组 do
    ...
    if 队伍处理类:取是否助战(玩家数据[id].队伍,n) == 0 then
      ...
      elseif 奖励参数<=95 then
        ...
        广播消息({内容=format("#S(小知了王)#R/%s#Y经过一番激烈的战斗，最终战胜了#R%s#Y，因此获得了其奖励的#G/%s#Y".."#"..取随机数(1,110),玩家数据[id].角色.数据.名称,任务数据[任务id].名称,名称),频道="xt"})
      elseif 奖励参数<=97 then
        玩家数据[id].角色:添加元宝(2,"小知了王",1)
        常规提示(id,"#Y/你获得了2元宝")
        广播消息({内容=format("#S(小知了王)#Y/经过一番激烈的战斗，玩家：#R"..玩家数据[id].角色.数据.名称.."#Y获得了#R2元宝")})
      end
    end
  end
  地图处理类:删除单位(任务数据[任务id].地图编号,任务数据[任务id].单位编号)
...
function 任务处理类:设置熔合装备任务(id,临时类型,级别,序列,星级,镶嵌类型,分类)
  local 任务物品 = {"高级召唤兽内丹","高级召唤兽内丹","高级召唤兽内丹"}
...
function 任务处理类:捣乱的水果(id)
  ...
  广播消息({内容=format("#S/(捣乱的水果)#Y已经刷新,各路英雄快去消灭它们吧#46"),频道="xt"})
...
function 任务处理类:完成青龙任务(任务id,数字id,类型)
  ...
  self.青龙经验 = math.floor(玩家数据[数字id].角色.数据.等级*玩家数据[数字id].角色.数据.等级*10)
...
function 任务处理类:完成玄武任务(任务id,id组,类型)
  ...
  for n=1,#id组 do
    if 队伍处理类:取是否助战(玩家数据[id组[n]].队伍,n) == 0 then
      ...
      self.青龙经验 = math.floor(玩家数据[id组[n]].角色.数据.等级*玩家数据[id组[n]].角色.数据.等级*8)
...
function 任务处理类:刷新世界BOSS(id)
  ...
  地图处理类:添加单位(任务id)
  广播消息({内容=format("#S(世界BOSS)#Y%s#G已经出现在#Y%s#G场景内",任务数据[任务id].名称,任务数据[任务id].地图名称),频道="xt"})
...
function 任务处理类:攻城木桩计算3(任务id,id组)
  for n=1,#id组 do
    local id=id组[n]
    ...
    local 玩家帮派 = 玩家数据[id].角色.数据.帮派
    if 玩家帮派==攻城数据.守城方.帮派名称  then
      for n=1,#攻城数据.攻城方 do
        if 攻城数据.攻城方[n].木桩伤害 ~=0 then
           攻城数据.攻城方[n].木桩伤害=攻城数据.攻城方[n].木桩伤害-50000000
           攻城数据.守城方.抵消伤害=攻城数据.守城方.抵消伤害+50000000
          if 攻城数据.攻城方[n].木桩伤害<=0 then
             攻城数据.攻城方[n].木桩伤害=0
          end
          发送数据(玩家数据[id].连接id,124,{攻城数据=攻城数据})
          写出文件([[tysj/攻城数据.txt]],table.tostring(攻城数据))
          常规提示(id,"#Y/成功防御攻城方的5000W伤害，为帮派做出卓越贡献")
        end
      end
    else
      for i=1,#攻城数据.攻城方 do
        if 玩家帮派==攻城数据.攻城方[i].帮派名称 then
           攻城数据.攻城方[i].木桩伤害 = 攻城数据.攻城方[i].木桩伤害+50000000
           发送数据(玩家数据[id].连接id,124,{攻城数据=攻城数据})
           常规提示(id,"#Y/成功击败敌方的5000W伤害，为帮派做出卓越贡献")
        end
      end
      if 攻城数据.守城方.帮派名称==nil then
        for i=1,#攻城数据.攻城方 do
          if 攻城数据.攻城方[i].木桩伤害>=1000000000 then
             攻城数据.攻城方={}
             攻城数据.守城方={抵消伤害=0,守城天数=0,帮派名称=玩家帮派}
             攻城开关=false
             写出文件([[tysj/攻城数据.txt]],table.tostring(攻城数据))
             常规提示(id,"#Y/恭喜你攻城成功，你们帮派获得长安城的拥有权，快去领奖吧，记得还可以领称谓")
             发送公告("#G长安城被#R"..玩家帮派.."#G帮派首次攻破，#S(攻城战)#G结束，大家快去双领取奖励吧")
             return
          end
        end
      end
...
function 任务处理类:攻城木桩计算2(任务id,id组)
  for n=1,#id组 do
    local id=id组[n]
    if 玩家数据[id].队长==false then
       return
    ...
    if 玩家帮派==攻城数据.守城方.帮派名称  then
      for n=1,#攻城数据.攻城方 do
        if 攻城数据.攻城方[n].木桩伤害 ~=0 then
           攻城数据.攻城方[n].木桩伤害=攻城数据.攻城方[n].木桩伤害-30000000
           攻城数据.守城方.抵消伤害=攻城数据.守城方.抵消伤害+30000000
          if 攻城数据.攻城方[n].木桩伤害<=0 then
             攻城数据.攻城方[n].木桩伤害=0
          end
          发送数据(玩家数据[id].连接id,124,{攻城数据=攻城数据})
          写出文件([[tysj/攻城数据.txt]],table.tostring(攻城数据))
          常规提示(id,"#Y/成功防御攻城方的3000W伤害，为帮派做出卓越贡献")
        end
      end
    else
      for i=1,#攻城数据.攻城方 do
        if 玩家帮派==攻城数据.攻城方[i].帮派名称 then
           攻城数据.攻城方[i].木桩伤害 = 攻城数据.攻城方[i].木桩伤害+30000000
           发送数据(玩家数据[id].连接id,124,{攻城数据=攻城数据})
           常规提示(id,"#Y/成功击败敌方的3000W伤害，为帮派做出卓越贡献")
        end
      end
      if 攻城数据.守城方.帮派名称==nil then
        for i=1,#攻城数据.攻城方 do
...
function 任务处理类:攻城木桩计算1(任务id,id组)
  for n=1,#id组 do
    local id=id组[n]
    if 玩家数据[id].队长==false then
       return
    ...
    if 玩家帮派==攻城数据.守城方.帮派名称  then
      for n=1,#攻城数据.攻城方 do
        if 攻城数据.攻城方[n].木桩伤害 ~=0 then
           攻城数据.攻城方[n].木桩伤害=攻城数据.攻城方[n].木桩伤害-10000000
           攻城数据.守城方.抵消伤害=攻城数据.守城方.抵消伤害+10000000
          if 攻城数据.攻城方[n].木桩伤害<=0 then
             攻城数据.攻城方[n].木桩伤害=0
          end
          发送数据(玩家数据[id].连接id,124,{攻城数据=攻城数据})
          写出文件([[tysj/攻城数据.txt]],table.tostring(攻城数据))
          常规提示(id,"#Y/成功防御攻城方的1000W伤害，为帮派做出卓越贡献")
        end
      end
    else
      for i=1,#攻城数据.攻城方 do
        if 玩家帮派==攻城数据.攻城方[i].帮派名称 then
           攻城数据.攻城方[i].木桩伤害 = 攻城数据.攻城方[i].木桩伤害+10000000
           发送数据(玩家数据[id].连接id,124,{攻城数据=攻城数据})
        end
      end
      if 攻城数据.守城方.帮派名称==nil then
...
function 任务处理类:攻城战判断()
  for n=1,#攻城数据.攻城方 do
    if 攻城数据.攻城方[n].木桩伤害 >=1000000000 then
       local 玩家帮派 = 攻城数据.攻城方[n].帮派名称
       攻城数据.攻城方={}
       攻城数据.守城方={抵消伤害=0,守城天数=0,帮派名称=玩家帮派}
       攻城开关=false
       地图处理类:清除地图玩家(1300,1001,412,72)
       写出文件([[tysj/攻城数据.txt]],table.tostring(攻城数据))
       常规提示(id,"#Y/恭喜你攻城成功，你们帮派获得长安城的拥有权，快去领奖吧，记得还可以领称谓")
       发送公告("#G长安城被#R"..玩家帮派.."#G帮派攻破，#S(攻城战)#G结束，大家快去双领取奖励吧")
    end
  end
end
function 任务处理类:攻城开启()
  ...
  攻城数据.攻城方={}
  写出文件([[tysj/攻城数据.txt]],table.tostring(攻城数据))
  发送公告("#R(长安攻城战)#G已经开启，各帮派从攻城战领奖处进入攻城地图进行攻城！！")
end
function 任务处理类:攻城结束()
  攻城数据.攻城方={}
  攻城开关=false
  if 攻城数据.守城方.守城天数~=nil then
     攻城数据.守城方.守城天数=攻城数据.守城方.守城天数+1
  end
  地图处理类:清除地图玩家(1300,1001,412,72)
  写出文件([[tysj/攻城数据.txt]],table.tostring(攻城数据))
  发送公告("#R"..攻城数据.守城方.帮派名称.."#G成功守住长安城#R"..攻城数据.守城方.守城天数.."#G天，#S(攻城战)#G结束，大家快去双领取奖励吧")
end

function 任务处理类:长安城城主()
  local 地图 = 1001
  local xy={}
  xy.x={228}
  xy.y={114}
  local 任务id="_80001_"..os.time().."_"..取随机数(88,99999999)
  任务数据[任务id]={
    id=任务id,
    起始=os.time(),
    结束=99999999,
    玩家id=id,
    队伍组={},
    名称=攻城数据.守城方.长安城城主.名称,
    锦衣=攻城数据.守城方.长安城城主.锦衣,
    模型=攻城数据.守城方.长安城城主.模型,
    武器=攻城数据.守城方.长安城城主.武器,
    当前编号 = n,
    称谓="长安城城主",
    武器等级=攻城数据.守城方.长安城城主.武器等级,
    武器染色方案=攻城数据.守城方.长安城城主.染色方案,
    武器染色组=攻城数据.守城方.长安城城主.染色组,
    x=xy.x[n],
    y=xy.y[n],
    行走开关=false,
    方向=0,
...
function 任务处理类:全服功臣()
  local 地图 = 1001
  local xy={}
  xy.x={231.4,236.4,241.8,247.1,252.6}
  xy.y={127.6,125.1,122.7,120.3,118}
  for n=1,5 do
    local 任务id="_80000_"..os.time().."_"..取随机数(88,99999999)
    任务数据[任务id]={
      id=任务id,
      起始=os.time(),
      结束=99999999,
...
function 任务处理类:恢复经验倍数()

  f函数.写配置(程序目录..[[定制难度.ini]],"定制任务","提升经验倍数","0")
  f函数.写配置(程序目录..[[定制难度.ini]],"定制任务","全服贡献物资","0")
  f函数.写配置(程序目录..[[定制难度.ini]],"定制任务","未领取物资人数","5")
  f函数.写配置(程序目录..[[定制难度.ini]],"定制任务","领取1","0")
  f函数.写配置(程序目录..[[定制难度.ini]],"定制任务","领取2","0")
  f函数.写配置(程序目录..[[定制难度.ini]],"定制任务","领取3","0")
  f函数.写配置(程序目录..[[定制难度.ini]],"定制任务","领取4","0")
  f函数.写配置(程序目录..[[定制难度.ini]],"定制任务","领取5","0")
  发送公告("#S(全区经验倍数)#G恢复正常，要想增加经验倍数，大家都去膜拜全服功臣吧，捐献物资越高，击败后的经验倍数越高")
end

function 任务处理类:提升经验倍数20(任务id,id组)
local 当前经验倍数=f函数.读配置(程序目录.."定制难度.ini","定制任务","提升经验倍数")+0
if 当前经验倍数< 0.2 then
  f函数.写配置(程序目录..[[定制难度.ini]],"定制任务","提升经验倍数","0.2")
  常规提示(id,"#Y/恭喜你完成全服提升经验怪物的击杀，全服所有玩家经验提升20%，同时您将站在名人堂之巅，受全服人膜拜")
  发送公告("#S(全区经验倍数)#G提升20%持续到下一个20点，感谢玩家#R"..玩家数据[id组[1]].角色.数据.名称.."#G带领队员挑战成功经验掌控者")
else
  常规提示(id,"#Y/很可惜别人快你们一步完成经验掌控者的挑战")
end
end
function 任务处理类:提升经验倍数50(任务id,id组)
local 当前经验倍数=f函数.读配置(程序目录.."定制难度.ini","定制任务","提升经验倍数")+0
if 当前经验倍数< 0.5 then
  f函数.写配置(程序目录..[[定制难度.ini]],"定制任务","提升经验倍数","0.5")
  常规提示(id,"#Y/恭喜你完成全服提升经验怪物的击杀，全服所有玩家经验提升50%，同时您将站在名人堂之巅，受全服人膜拜")
  发送公告("#S(全区经验倍数)#G提升50%持续到下一个20点，感谢玩家#R"..玩家数据[id组[1]].角色.数据.名称.."#G带领队员挑战成功经验掌控者")
else
  常规提示(id,"#Y/很可惜别人快你们一步完成经验掌控者的挑战")
end
end
...
local 当前经验倍数=f函数.读配置(程序目录.."定制难度.ini","定制任务","提升经验倍数")+0
if 当前经验倍数 < 1 then
  f函数.写配置(程序目录..[[定制难度.ini]],"定制任务","提升经验倍数","1")
  常规提示(id,"#Y/恭喜你完成全服提升经验怪物的击杀，全服所有玩家经验提升100%，同时您将站在名人堂之巅，受全服人膜拜")
  发送公告("#S(全区经验倍数)#G提升100%持续到下一个20点，感谢玩家#R"..玩家数据[id组[1]].角色.数据.名称.."#G带领队员挑战成功经验掌控者")
else
  常规提示(id,"#Y/很可惜别人快你们一步完成经验掌控者的挑战")
end
end
function 任务处理类:单人闯关(任务id,id组)
  ...
  for n=1,#id组 do
    ...
    玩家数据[id].角色:刷新信息()
    常规提示(id,"#Y/恭喜你完成单人闯关，气血 命中 伤害 灵力 防御 速度各提升5点")
  end
end
function 任务处理类:初级经验挂机(任务id,id组)
  local 经验=2000000
  local 银子=500000
  for n=1,#id组 do
    local id=id组[n]
    --玩家数据[id].战斗==0
    玩家数据[id].角色.数据.自动遇怪时间=os.time()
    if 队伍处理类:取是否助战(玩家数据[id].队伍,n) == 0 then
      if 玩家数据[id].角色.数据.地图数据.编号==1001 and 攻城数据.守城方.帮派名称==nil then
         经验=经验*0.8
         银子=银子*0.8
         常规提示(id,"#Y长安城现在属于无帮派占领状态，你的经验和银币获取减少20%，挂机请远离长安城")
      end
      if 玩家数据[id].角色.数据.地图数据.编号==1001 then
        if 攻城数据.守城方.帮派名称~=nil then
          if 玩家数据[id].角色.数据.帮派~=攻城数据.守城方.帮派名称 then
            经验=经验*0.8
            银子=银子*0.8
            常规提示(id,"#Y长安城现在属于("..攻城数据.守城方.帮派名称..")帮派占领，你的经验和银币获取减少20%，挂机请远离长安城")
          else
            经验=2400000
            银子=600000
            常规提示(id,"#Y长安城现在属于("..攻城数据.守城方.帮派名称..")帮派占领，你的帮派属于此帮派，收益提升20%")
          end
        end
      end
      for v=1,#玩家数据[id].召唤兽.数据 do
        if 玩家数据[id].召唤兽.数据[v].参战信息==1  then
          if 玩家数据[id].召唤兽.数据[v].名称=="夏日超甜" and 玩家数据[id].召唤兽.数据[v].潜力<5 and 玩家数据[id].召唤兽.数据[v].潜力>0 then
            经验=10000000
            银子=2500000
          end
        end
      end
      玩家数据[id].角色:添加经验(经验,"初级经验挂机",1)
      玩家数据[id].角色:添加银子(银子,"初级经验挂机",1)
      --广播消息({内容=format("#S(初级经验挂机)#G过程中，玩家#R"..玩家数据[id].角色.数据.名称.."#G获得基础经验#R100W"),频道="xt"})
      if 玩家数据[id].角色.数据.参战信息~=nil then
        玩家数据[id].召唤兽:获得经验(玩家数据[id].角色.数据.参战宝宝.认证码,math.floor(经验*0.8),id,"初级经验挂机")
      end
      local 奖励参数=取随机数(1,100)
      if 奖励参数<=1 then
        玩家数据[id].角色:添加元宝(1,"初级经验挂机",1)
        常规提示(id,"#Y/你获得了1元宝")
        广播消息({内容=format("#S(初级经验挂机)#G过程中，玩家#R"..玩家数据[id].角色.数据.名称.."#G获得1元宝"),频道="xt"})
      end
    end
  end
end
function 任务处理类:低级经验挂机(任务id,id组)
  local 经验=3000000
  local 银子=500000
  for n=1,#id组 do
    local id=id组[n]
    ...
    if 队伍处理类:取是否助战(玩家数据[id].队伍,n) == 0 then
      ...
      玩家数据[id].角色:添加经验(经验,"低级经验挂机",1)
      玩家数据[id].角色:添加银子(银子,"低级经验挂机",1)
      --广播消息({内容=format("#S(低级经验挂机)#G过程中，玩家#R"..玩家数据[id].角色.数据.名称.."#G获得基础经验#R200W"),频道="xt"})
      if 玩家数据[id].角色.数据.参战信息~=nil then
        玩家数据[id].召唤兽:获得经验(玩家数据[id].角色.数据.参战宝宝.认证码,math.floor(经验*0.8),id,"低级经验挂机")
      end
      local 奖励参数=取随机数(1,100)
      if 奖励参数<=2 then
        玩家数据[id].角色:添加元宝(1,"低级经验挂机",1)
        常规提示(id,"#Y/你获得了1元宝")
        广播消息({内容=format("#S(低级经验挂机)#G过程中，玩家#R"..玩家数据[id].角色.数据.名称.."#G获得1元宝"),频道="xt"})
      end
    end
  end
end
function 任务处理类:中级经验挂机(任务id,id组)
  local 经验=4000000
  local 银子=500000
  for n=1,#id组 do
    local id=id组[n]
    ...
    if 队伍处理类:取是否助战(玩家数据[id].队伍,n) == 0 then
      ...
      玩家数据[id].角色:添加经验(经验,"中级经验挂机",1)
      玩家数据[id].角色:添加银子(银子,"中级经验挂机",1)
      --广播消息({内容=format("#S(中级经验挂机)#G过程中，玩家#R"..玩家数据[id].角色.数据.名称.."#G获得基础经验#R300W"),频道="xt"})
      if 玩家数据[id].角色.数据.参战信息~=nil then
        玩家数据[id].召唤兽:获得经验(玩家数据[id].角色.数据.参战宝宝.认证码,math.floor(经验*0.8),id,"中级经验挂机")
      end
      local 奖励参数=取随机数(1,100)
      if 奖励参数<=3 then
        玩家数据[id].角色:添加元宝(1,"中级经验挂机",1)
        常规提示(id,"#Y/你获得了1元宝")
        广播消息({内容=format("#S(中级经验挂机)#G过程中，玩家#R"..玩家数据[id].角色.数据.名称.."#G获得1元宝"),频道="xt"})
      end
    end
  end
end
function 任务处理类:高级经验挂机(任务id,id组)
  local 经验=5000000
  local 银子=500000
  for n=1,#id组 do
    local id=id组[n]
    ...
    if 队伍处理类:取是否助战(玩家数据[id].队伍,n) == 0 then
      ...
      玩家数据[id].角色:添加经验(经验,"高级经验挂机",1)
      玩家数据[id].角色:添加银子(银子,"高级经验挂机",1)
      --广播消息({内容=format("#S(高级经验挂机)#G过程中，玩家#R"..玩家数据[id].角色.数据.名称.."#G获得基础经验#R400W"),频道="xt"})
      if 玩家数据[id].角色.数据.参战信息~=nil then
        玩家数据[id].召唤兽:获得经验(玩家数据[id].角色.数据.参战宝宝.认证码,math.floor(经验*0.8),id,"高级经验挂机")
      end
      local 奖励参数=取随机数(1,100)
      if 奖励参数<=4 then
        玩家数据[id].角色:添加元宝(1,"高级经验挂机",1)
        常规提示(id,"#Y/你获得了1元宝")
        广播消息({内容=format("#S(高级经验挂机)#G过程中，玩家#R"..玩家数据[id].角色.数据.名称.."#G获得1元宝"),频道="xt"})
      end
    end
  end
end
function 任务处理类:超级经验挂机(任务id,id组)
  local 经验=6000000
  local 银子=500000
  for n=1,#id组 do
    local id=id组[n]
    ...
    if 队伍处理类:取是否助战(玩家数据[id].队伍,n) == 0 then
      ...
      玩家数据[id].角色:添加经验(经验,"超级经验挂机",1)
      玩家数据[id].角色:添加银子(银子,"超级经验挂机",1)
      --广播消息({内容=format("#S(超级经验挂机)#G过程中，玩家#R"..玩家数据[id].角色.数据.名称.."#G获得基础经验#R500W"),频道="xt"})
      if 玩家数据[id].角色.数据.参战信息~=nil then
        玩家数据[id].召唤兽:获得经验(玩家数据[id].角色.数据.参战宝宝.认证码,math.floor(经验*0.8),id,"超级经验挂机")
      end
      local 奖励参数=取随机数(1,100)
      if 奖励参数<=5 then
        玩家数据[id].角色:添加元宝(1,"超级经验挂机",1)
        常规提示(id,"#Y/你获得了1元宝")
        广播消息({内容=format("#S(超级经验挂机)#G过程中，玩家#R"..玩家数据[id].角色.数据.名称.."#G获得1元宝"),频道="xt"})
      end
    end
  end
end
function 任务处理类:初级银币挂机(任务id,id组)
  local 经验=1000000
  local 银子=1000000
  for n=1,#id组 do
    local id=id组[n]
    ...
    if 队伍处理类:取是否助战(玩家数据[id].队伍,n) == 0 then
      ...
      玩家数据[id].角色:添加经验(经验,"初级银币挂机",1)
      玩家数据[id].角色:添加银子(银子,"初级银币挂机",1)
      --广播消息({内容=format("#S(初级银币挂机)#G过程中，玩家#R"..玩家数据[id].角色.数据.名称.."#G获得基础银币#R100W"),频道="xt"})
      if 玩家数据[id].角色.数据.参战信息~=nil then
        玩家数据[id].召唤兽:获得经验(玩家数据[id].角色.数据.参战宝宝.认证码,math.floor(经验*0.8),id,"初级银币挂机")
      end
      local 奖励参数=取随机数(1,100)
      if 奖励参数<=1 then
        玩家数据[id].角色:添加元宝(1,"初级银币挂机",1)
        常规提示(id,"#Y/你获得了1元宝")
        广播消息({内容=format("#S(初级银币挂机)#G过程中，玩家#R"..玩家数据[id].角色.数据.名称.."#G获得1元宝"),频道="xt"})
      end
    end
  end
end
function 任务处理类:低级银币挂机(任务id,id组)
  local 经验=1000000
  local 银子=1500000
  for n=1,#id组 do
    local id=id组[n]
    ...
    if 队伍处理类:取是否助战(玩家数据[id].队伍,n) == 0 then
      ...
      玩家数据[id].角色:添加经验(经验,"低级银币挂机",1)
      玩家数据[id].角色:添加银子(银子,"低级银币挂机",1)
      --广播消息({内容=format("#S(低级银币挂机)#G过程中，玩家#R"..玩家数据[id].角色.数据.名称.."#G获得基础银币#R150W"),频道="xt"})
      if 玩家数据[id].角色.数据.参战信息~=nil then
        玩家数据[id].召唤兽:获得经验(玩家数据[id].角色.数据.参战宝宝.认证码,math.floor(经验*0.8),id,"低级银币挂机")
      end
      local 奖励参数=取随机数(1,100)
      if 奖励参数<=2 then
        玩家数据[id].角色:添加元宝(1,"低级银币挂机",1)
        常规提示(id,"#Y/你获得了1元宝")
        广播消息({内容=format("#S(低级银币挂机)#G过程中，玩家#R"..玩家数据[id].角色.数据.名称.."#G获得1元宝"),频道="xt"})
      end
    end
  end
end
function 任务处理类:中级银币挂机(任务id,id组)
  local 经验=1000000
  local 银子=2000000
  for n=1,#id组 do
    local id=id组[n]
    ...
    if 队伍处理类:取是否助战(玩家数据[id].队伍,n) == 0 then
      ...
      玩家数据[id].角色:添加经验(经验,"中级银币挂机",1)
      玩家数据[id].角色:添加银子(银子,"中级银币挂机",1)
      --广播消息({内容=format("#S(中级银币挂机)#G过程中，玩家#R"..玩家数据[id].角色.数据.名称.."#G获得基础银币#R200W"),频道="xt"})
      if 玩家数据[id].角色.数据.参战信息~=nil then
        玩家数据[id].召唤兽:获得经验(玩家数据[id].角色.数据.参战宝宝.认证码,math.floor(经验*0.8),id,"中级银币挂机")
      end
      local 奖励参数=取随机数(1,100)
      if 奖励参数<=3 then
        玩家数据[id].角色:添加元宝(1,"中级银币挂机",1)
        常规提示(id,"#Y/你获得了1元宝")
        广播消息({内容=format("#S(中级银币挂机)#G过程中，玩家#R"..玩家数据[id].角色.数据.名称.."#G获得1元宝"),频道="xt"})
      end
    end
  end
end
function 任务处理类:高级银币挂机(任务id,id组)
  local 经验=1000000
  local 银子=2500000
  for n=1,#id组 do
    local id=id组[n]
    ...
    if 队伍处理类:取是否助战(玩家数据[id].队伍,n) == 0 then
      ...
      玩家数据[id].角色:添加经验(经验,"高级银币挂机",1)
      玩家数据[id].角色:添加银子(银子,"高级银币挂机",1)
      --广播消息({内容=format("#S(高级银币挂机)#G过程中，玩家#R"..玩家数据[id].角色.数据.名称.."#G获得基础银币#R250W"),频道="xt"})
      if 玩家数据[id].角色.数据.参战信息~=nil then
        玩家数据[id].召唤兽:获得经验(玩家数据[id].角色.数据.参战宝宝.认证码,math.floor(经验*0.8),id,"高级银币挂机")
      end
      local 奖励参数=取随机数(1,100)
      if 奖励参数<=4 then
        玩家数据[id].角色:添加元宝(1,"高级银币挂机",1)
        常规提示(id,"#Y/你获得了1元宝")
        广播消息({内容=format("#S(高级银币挂机)#G过程中，玩家#R"..玩家数据[id].角色.数据.名称.."#G获得1元宝"),频道="xt"})
      end
    end
  end
end
function 任务处理类:超级银币挂机(任务id,id组)
  local 经验=1000000
  local 银子=3000000
  for n=1,#id组 do
    local id=id组[n]
    ...
    if 队伍处理类:取是否助战(玩家数据[id].队伍,n) == 0 then
      ...
      玩家数据[id].角色:添加经验(经验,"超级银币挂机",1)
      玩家数据[id].角色:添加银子(银子,"超级银币挂机",1)
      --广播消息({内容=format("#S(超级银币挂机)#G过程中，玩家#R"..玩家数据[id].角色.数据.名称.."#G获得基础银币#R300W"),频道="xt"})
      if 玩家数据[id].角色.数据.参战信息~=nil then
        玩家数据[id].召唤兽:获得经验(玩家数据[id].角色.数据.参战宝宝.认证码,math.floor(经验*0.8),id,"超级银币挂机")
      end
      local 奖励参数=取随机数(1,100)
      if 奖励参数<=5 then
        玩家数据[id].角色:添加元宝(1,"超级银币挂机",1)
        常规提示(id,"#Y/你获得了1元宝")
        广播消息({内容=format("#S(超级银币挂机)#G过程中，玩家#R"..玩家数据[id].角色.数据.名称.."#G获得1元宝"),频道="xt"})
      end
    end
  end
end
function 任务处理类:初级活跃挂机(任务id,id组)
  local 经验=1000000
  local 银子=500000
  local 活跃度=1
  for n=1,#id组 do
    ...
    if 队伍处理类:取是否助战(玩家数据[id].队伍,n) == 0 then
      ...
      玩家数据[id].角色:添加经验(经验,"初级活跃挂机",1)
      玩家数据[id].角色:添加银子(银子,"初级活跃挂机",1)
      玩家数据[id].角色:添加活跃度(活跃度,"初级活跃挂机",1)
      --广播消息({内容=format("#S(初级活跃挂机)#G过程中，玩家#R"..玩家数据[id].角色.数据.名称.."#G获得活跃#R1点"),频道="xt"})
      if 玩家数据[id].角色.数据.参战信息~=nil then
        玩家数据[id].召唤兽:获得经验(玩家数据[id].角色.数据.参战宝宝.认证码,math.floor(经验*0.8),id,"初级活跃挂机")
      end
      local 奖励参数=取随机数(1,100)
      if 奖励参数<=1 then
        玩家数据[id].角色:添加元宝(1,"初级活跃挂机",1)
        常规提示(id,"#Y/你获得了1元宝")
        广播消息({内容=format("#S(初级活跃挂机)#G过程中，玩家#R"..玩家数据[id].角色.数据.名称.."#G获得1元宝"),频道="xt"})
      end
    end
  end
end
function 任务处理类:低级活跃挂机(任务id,id组)
  local 经验=1000000
  local 银子=500000
  local 活跃度=2
  for n=1,#id组 do
    ...
    if 队伍处理类:取是否助战(玩家数据[id].队伍,n) == 0 then
      ...
      玩家数据[id].角色:添加经验(经验,"低级活跃挂机",1)
      玩家数据[id].角色:添加银子(银子,"低级活跃挂机",1)
      玩家数据[id].角色:添加活跃度(活跃度,"低级活跃挂机",1)
      --广播消息({内容=format("#S(低级活跃挂机)#G过程中，玩家#R"..玩家数据[id].角色.数据.名称.."#G获得活跃#R2点"),频道="xt"})
      if 玩家数据[id].角色.数据.参战信息~=nil then
        玩家数据[id].召唤兽:获得经验(玩家数据[id].角色.数据.参战宝宝.认证码,math.floor(经验*0.8),id,"低级活跃挂机")
      end
      local 奖励参数=取随机数(1,100)
      if 奖励参数<=2 then
        玩家数据[id].角色:添加元宝(1,"低级活跃挂机",1)
        常规提示(id,"#Y/你获得了1元宝")
        广播消息({内容=format("#S(低级活跃挂机)#G过程中，玩家#R"..玩家数据[id].角色.数据.名称.."#G获得1元宝"),频道="xt"})
      end
    end
  end
end
function 任务处理类:中级活跃挂机(任务id,id组)
  local 经验=1000000
  local 银子=500000
  local 活跃度=3
  for n=1,#id组 do
    ...
    if 队伍处理类:取是否助战(玩家数据[id].队伍,n) == 0 then
      ...
      玩家数据[id].角色:添加经验(经验,"中级活跃挂机",1)
      玩家数据[id].角色:添加银子(银子,"中级活跃挂机",1)
      玩家数据[id].角色:添加活跃度(活跃度,"中级活跃挂机",1)
      --广播消息({内容=format("#S(中级活跃挂机)#G过程中，玩家#R"..玩家数据[id].角色.数据.名称.."#G获得活跃#R3点"),频道="xt"})
      if 玩家数据[id].角色.数据.参战信息~=nil then
        玩家数据[id].召唤兽:获得经验(玩家数据[id].角色.数据.参战宝宝.认证码,math.floor(经验*0.8),id,"中级活跃挂机")
      end
      local 奖励参数=取随机数(1,100)
      if 奖励参数<=3 then
        玩家数据[id].角色:添加元宝(1,"中级活跃挂机",1)
        常规提示(id,"#Y/你获得了1元宝")
        广播消息({内容=format("#S(中级活跃挂机)#G过程中，玩家#R"..玩家数据[id].角色.数据.名称.."#G获得1元宝"),频道="xt"})
      end
    end
  end
end
function 任务处理类:高级活跃挂机(任务id,id组)
  local 经验=1000000
  local 银子=500000
  local 活跃度=4
  for n=1,#id组 do
    ...
    if 队伍处理类:取是否助战(玩家数据[id].队伍,n) == 0 then
      ...
      玩家数据[id].角色:添加经验(经验,"高级活跃挂机",1)
      玩家数据[id].角色:添加银子(银子,"高级活跃挂机",1)
      玩家数据[id].角色:添加活跃度(活跃度,"高级活跃挂机",1)
      --广播消息({内容=format("#S(高级活跃挂机)#G过程中，玩家#R"..玩家数据[id].角色.数据.名称.."#G获得活跃#R4点"),频道="xt"})
      if 玩家数据[id].角色.数据.参战信息~=nil then
        玩家数据[id].召唤兽:获得经验(玩家数据[id].角色.数据.参战宝宝.认证码,math.floor(经验*0.8),id,"高级活跃挂机")
      end
      local 奖励参数=取随机数(1,100)
      if 奖励参数<=4 then
        玩家数据[id].角色:添加元宝(1,"高级活跃挂机",1)
        常规提示(id,"#Y/你获得了1元宝")
        广播消息({内容=format("#S(高级活跃挂机)#G过程中，玩家#R"..玩家数据[id].角色.数据.名称.."#G获得1元宝"),频道="xt"})
      end
    end
  end
end
function 任务处理类:超级活跃挂机(任务id,id组)
  local 经验=1000000
  local 银子=500000
  local 活跃度=5
  for n=1,#id组 do
    ...
    if 队伍处理类:取是否助战(玩家数据[id].队伍,n) == 0 then
      ...
      玩家数据[id].角色:添加经验(经验,"超级活跃挂机",1)
      玩家数据[id].角色:添加银子(银子,"超级活跃挂机",1)
      玩家数据[id].角色:添加活跃度(活跃度,"超级活跃挂机",1)
      --广播消息({内容=format("#S(超级活跃挂机)#G过程中，玩家#R"..玩家数据[id].角色.数据.名称.."#G获得活跃#R5点"),频道="xt"})
      if 玩家数据[id].角色.数据.参战信息~=nil then
        玩家数据[id].召唤兽:获得经验(玩家数据[id].角色.数据.参战宝宝.认证码,math.floor(经验*0.8),id,"超级活跃挂机")
      end
      local 奖励参数=取随机数(1,100)
      if 奖励参数<=4 then
        玩家数据[id].角色:添加元宝(1,"超级活跃挂机",1)
        常规提示(id,"#Y/你获得了1元宝")
        广播消息({内容=format("#S(超级活跃挂机)#G过程中，玩家#R"..玩家数据[id].角色.数据.名称.."#G获得1元宝"),频道="xt"})
      end
    end
  end
end
...
function 任务处理类:刷出新服福利BOSS()
  ...
  广播消息({内容=format("#R福利时间到，一波福利怪#Y%s#G已经出现在#Y%s、%s、%s、%s#G场景内","新服福利BOSS",刷新地图[1],刷新地图[2],刷新地图[3],刷新地图[4]),频道="xt"})
end
...
function 任务处理类:完成新服福利BOSS(任务id,id组)
  ...
  for n=1,#id组 do
    ...
    if 队伍处理类:取是否助战(玩家数据[id].队伍,n) == 0 then
      ...
      玩家数据[id].角色:添加元宝(1,"新服福利BOSS",1)
      常规提示(id,"#Y/你获得了1元宝")
      广播消息({内容=format("#S(新服福利BOSS)#Y/经过一番激烈的战斗，玩家：#R"..玩家数据[id].角色.数据.名称.."#Y获得了#R1元宝")})
    end
  end
  地图处理类:删除单位(任务数据[任务id].地图编号,任务数据[任务id].单位编号)
  任务数据[任务id]=nil
...
function 任务处理类:刷出树枝怪物()
  local 地图范围={1001,1004,1005,1006,1007,1008}
  local 地图=地图范围[取随机数(1,#地图范围)]
  for i=1,9999999 do
    local xy=地图处理类.地图坐标[地图]:取随机点()
...
function 任务处理类:完成七十二地煞星(任务id,id组)
  ...
  local 难度 = 任务数据[任务id].难度
  if 难度 <= 10 then
    经验 = 10000000 + 难度*15000000
    银子 = 10000000 + 难度*15000000
  elseif 难度 == 11 then
    经验 = 160000000
    银子 = 160000000
  ...
  if 任务数据[任务id].难度 == 8 then
    玩家数据[id组[1]].角色:添加称谓(id组[1],"地煞勇士")
