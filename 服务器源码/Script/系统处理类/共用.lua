...
function 取队长挂机权限(id)
  if 玩家数据[id].队伍==0 or 玩家数据[id].队伍==nil then
    return false
...
function 取队伍平均战斗加速(队伍id,id)
  if 队伍数据[队伍id]==nil then
  return 0--玩家数据[id].角色.数据.战斗加速
  end
  local 队伍平均战斗加速=0
  if 队伍数据[队伍id]~=nil then
    for n=1,#队伍数据[队伍id].成员数据 do
      队伍平均战斗加速=队伍平均战斗加速+玩家数据[队伍数据[队伍id].成员数据[n]].角色.数据.强化技能[11].等级
    end
    队伍平均战斗加速=队伍平均战斗加速/#队伍数据[队伍id].成员数据
    return 队伍平均战斗加速
  else
  return 队伍平均战斗加速
  end
...
function 保存系统数据()
  ...
  for n, v in pairs(任务数据) do
    if 任务数据[n].类型==10 or 任务数据[n].类型==13 or 任务数据[n].类型==7758 then
      数量=数量+1
...
function 飞升降修处理(id)
  ...
  for i=1,#as1 do
    if 玩家数据[id].角色.数据.bb修炼[as1[i]][1]==20 then
    ...
    elseif 玩家数据[id].角色.数据.bb修炼[as1[i]][1]==19 then
        玩家数据[id].角色.数据.bb修炼[as1[i]][1]=玩家数据[id].角色.数据.bb修炼[as1[i]][1]-4
        玩家数据[id].角色.数据.bb修炼[as1[i]][3]=24
    elseif 玩家数据[id].角色.数据.bb修炼[as1[i]][1]==18 then
        玩家数据[id].角色.数据.bb修炼[as1[i]][1]=玩家数据[id].角色.数据.bb修炼[as1[i]][1]-4
        玩家数据[id].角色.数据.bb修炼[as1[i]][3]=24
    elseif 玩家数据[id].角色.数据.bb修炼[as1[i]][1]==17 then
        玩家数据[id].角色.数据.bb修炼[as1[i]][1]=玩家数据[id].角色.数据.bb修炼[as1[i]][1]-3
        玩家数据[id].角色.数据.bb修炼[as1[i]][3]=23
    elseif 玩家数据[id].角色.数据.bb修炼[as1[i]][1]==16 then
        玩家数据[id].角色.数据.bb修炼[as1[i]][1]=玩家数据[id].角色.数据.bb修炼[as1[i]][1]-3
        玩家数据[id].角色.数据.bb修炼[as1[i]][3]=23
    elseif 玩家数据[id].角色.数据.bb修炼[as1[i]][1]==15 then
        玩家数据[id].角色.数据.bb修炼[as1[i]][1]=玩家数据[id].角色.数据.bb修炼[as1[i]][1]-2
        玩家数据[id].角色.数据.bb修炼[as1[i]][3]=22
    elseif 玩家数据[id].角色.数据.bb修炼[as1[i]][1]==14 then
        玩家数据[id].角色.数据.bb修炼[as1[i]][1]=玩家数据[id].角色.数据.bb修炼[as1[i]][1]-2
        玩家数据[id].角色.数据.bb修炼[as1[i]][3]=22
    elseif 玩家数据[id].角色.数据.bb修炼[as1[i]][1]==13 then
        玩家数据[id].角色.数据.bb修炼[as1[i]][1]=玩家数据[id].角色.数据.bb修炼[as1[i]][1]-1
        玩家数据[id].角色.数据.bb修炼[as1[i]][3]=21
    end
  end
end
