  ...
  for n=1,#self.参战单位 do
    ...
    if self.参战单位[n].队伍~=0 and self.参战单位[n].系统队友==nil then
      if self.参战单位[n].类型=="角色" and  self.参战单位[n].助战编号 == nil then
        ...
        if self.参战单位[n].类型=="角色" and self.参战单位[n].门派 =="女儿村" then
          self.参战单位[n].速度 = 9999
        end
      --检查符石效果
        for i,v in pairs(玩家数据[self.参战单位[n].玩家id].角色.数据.装备) do
          ...
          if v~=nil and 玩家数据[self.参战单位[n].玩家id].道具.数据[v]~=nil and 玩家数据[self.参战单位[n].玩家id].道具.数据[v].符石组合 ~= nil then
            ...
            elseif 玩家数据[self.参战单位[n].玩家id].道具.数据[v].符石组合.符石组合 =="隔山打牛" then
              if 玩家数据[self.参战单位[n].玩家id].道具.数据[v].符石组合.等级 == 1 then
                self.参战单位[n].灵力 = self.参战单位[n].灵力 + 80
              elseif  玩家数据[self.参战单位[n].玩家id].道具.数据[v].符石组合.等级== 2 then
                self.参战单位[n].灵力 = self.参战单位[n].灵力 + 120
              elseif  玩家数据[self.参战单位[n].玩家id].道具.数据[v].符石组合.等级== 3 then
                self.参战单位[n].灵力 = self.参战单位[n].灵力 + 170
              elseif  玩家数据[self.参战单位[n].玩家id].道具.数据[v].符石组合.等级==4 then
                self.参战单位[n].灵力 = self.参战单位[n].灵力 + 200
              end
            elseif 玩家数据[self.参战单位[n].玩家id].道具.数据[v].符石组合.符石组合 =="凤舞九天" then
              if 玩家数据[self.参战单位[n].玩家id].道具.数据[v].符石组合.等级 == 1 then
                self.参战单位[n].凤舞九天 = self.参战单位[n].凤舞九天+self.参战单位[n].等级*1
              elseif  玩家数据[self.参战单位[n].玩家id].道具.数据[v].符石组合.等级== 2 then
                self.参战单位[n].凤舞九天 = self.参战单位[n].凤舞九天+self.参战单位[n].等级*4
              elseif  玩家数据[self.参战单位[n].玩家id].道具.数据[v].符石组合.等级== 3 then
                self.参战单位[n].凤舞九天 = self.参战单位[n].凤舞九天+self.参战单位[n].等级*6
              elseif  玩家数据[self.参战单位[n].玩家id].道具.数据[v].符石组合.等级==4 then
                self.参战单位[n].凤舞九天 = self.参战单位[n].凤舞九天+self.参战单位[n].等级*10
              end
    ...
    if self.参战单位[n].类型~="角色" and self.参战单位[n].类型~="系统角色" and self.参战单位[n].类型 == "bb" then
      ...
      if 玩家数据[self.参战单位[n].玩家id] ~= nil then
        for i=1,#玩家数据[self.参战单位[n].玩家id].召唤兽.数据 do
          if 玩家数据[self.参战单位[n].玩家id].召唤兽.数据[i].参战信息 ~= nil then
...
function 战斗处理类:取难度系数(任务id)
  ...
  elseif self.战斗类型 == 100149 then --初级经验挂机
    难度系数[1] = f函数.读配置(程序目录.."定制难度.ini","定制任务","初级经验挂机气血")
    难度系数[2] = f函数.读配置(程序目录.."定制难度.ini","定制任务","初级经验挂机伤害")
    难度系数[3] = f函数.读配置(程序目录.."定制难度.ini","定制任务","初级经验挂机防御")
    难度系数[4] = f函数.读配置(程序目录.."定制难度.ini","定制任务","初级经验挂机灵力")
    难度系数[5] = f函数.读配置(程序目录.."定制难度.ini","定制任务","初级经验挂机速度")
    难度系数[6] = f函数.读配置(程序目录.."定制难度.ini","定制任务","初级经验挂机法防")
  elseif self.战斗类型 == 100150 then --低级经验挂机
    难度系数[1] = f函数.读配置(程序目录.."定制难度.ini","定制任务","低级经验挂机气血")
    难度系数[2] = f函数.读配置(程序目录.."定制难度.ini","定制任务","低级经验挂机伤害")
    难度系数[3] = f函数.读配置(程序目录.."定制难度.ini","定制任务","低级经验挂机防御")
    难度系数[4] = f函数.读配置(程序目录.."定制难度.ini","定制任务","低级经验挂机灵力")
    难度系数[5] = f函数.读配置(程序目录.."定制难度.ini","定制任务","低级经验挂机速度")
    难度系数[6] = f函数.读配置(程序目录.."定制难度.ini","定制任务","低级经验挂机法防")
  elseif self.战斗类型 == 100151 then --中级经验挂机
    难度系数[1] = f函数.读配置(程序目录.."定制难度.ini","定制任务","中级经验挂机气血")
    难度系数[2] = f函数.读配置(程序目录.."定制难度.ini","定制任务","中级经验挂机伤害")
    难度系数[3] = f函数.读配置(程序目录.."定制难度.ini","定制任务","中级经验挂机防御")
    难度系数[4] = f函数.读配置(程序目录.."定制难度.ini","定制任务","中级经验挂机灵力")
    难度系数[5] = f函数.读配置(程序目录.."定制难度.ini","定制任务","中级经验挂机速度")
    难度系数[6] = f函数.读配置(程序目录.."定制难度.ini","定制任务","中级经验挂机法防")
  elseif self.战斗类型 == 100152 then --高级经验挂机
    难度系数[1] = f函数.读配置(程序目录.."定制难度.ini","定制任务","高级经验挂机气血")
    难度系数[2] = f函数.读配置(程序目录.."定制难度.ini","定制任务","高级经验挂机伤害")
    难度系数[3] = f函数.读配置(程序目录.."定制难度.ini","定制任务","高级经验挂机防御")
    难度系数[4] = f函数.读配置(程序目录.."定制难度.ini","定制任务","高级经验挂机灵力")
    难度系数[5] = f函数.读配置(程序目录.."定制难度.ini","定制任务","高级经验挂机速度")
    难度系数[6] = f函数.读配置(程序目录.."定制难度.ini","定制任务","高级经验挂机法防")
  elseif self.战斗类型 == 100153 then --超级经验挂机
    难度系数[1] = f函数.读配置(程序目录.."定制难度.ini","定制任务","超级经验挂机气血")
    难度系数[2] = f函数.读配置(程序目录.."定制难度.ini","定制任务","超级经验挂机伤害")
    难度系数[3] = f函数.读配置(程序目录.."定制难度.ini","定制任务","超级经验挂机防御")
    难度系数[4] = f函数.读配置(程序目录.."定制难度.ini","定制任务","超级经验挂机灵力")
    难度系数[5] = f函数.读配置(程序目录.."定制难度.ini","定制任务","超级经验挂机速度")
    难度系数[6] = f函数.读配置(程序目录.."定制难度.ini","定制任务","超级经验挂机法防")
  elseif self.战斗类型 == 100154 then --初级银币挂机
    难度系数[1] = f函数.读配置(程序目录.."定制难度.ini","定制任务","初级银币挂机气血")
    难度系数[2] = f函数.读配置(程序目录.."定制难度.ini","定制任务","初级银币挂机伤害")
    难度系数[3] = f函数.读配置(程序目录.."定制难度.ini","定制任务","初级银币挂机防御")
    难度系数[4] = f函数.读配置(程序目录.."定制难度.ini","定制任务","初级银币挂机灵力")
    难度系数[5] = f函数.读配置(程序目录.."定制难度.ini","定制任务","初级银币挂机速度")
    难度系数[6] = f函数.读配置(程序目录.."定制难度.ini","定制任务","初级银币挂机法防")
  elseif self.战斗类型 == 100155 then --低级银币挂机
    难度系数[1] = f函数.读配置(程序目录.."定制难度.ini","定制任务","低级银币挂机气血")
    难度系数[2] = f函数.读配置(程序目录.."定制难度.ini","定制任务","低级银币挂机伤害")
    难度系数[3] = f函数.读配置(程序目录.."定制难度.ini","定制任务","低级银币挂机防御")
    难度系数[4] = f函数.读配置(程序目录.."定制难度.ini","定制任务","低级银币挂机灵力")
    难度系数[5] = f函数.读配置(程序目录.."定制难度.ini","定制任务","低级银币挂机速度")
    难度系数[6] = f函数.读配置(程序目录.."定制难度.ini","定制任务","低级银币挂机法防")
  elseif self.战斗类型 == 100156 then --中级银币挂机
    难度系数[1] = f函数.读配置(程序目录.."定制难度.ini","定制任务","中级银币挂机气血")
    难度系数[2] = f函数.读配置(程序目录.."定制难度.ini","定制任务","中级银币挂机伤害")
    难度系数[3] = f函数.读配置(程序目录.."定制难度.ini","定制任务","中级银币挂机防御")
    难度系数[4] = f函数.读配置(程序目录.."定制难度.ini","定制任务","中级银币挂机灵力")
    难度系数[5] = f函数.读配置(程序目录.."定制难度.ini","定制任务","中级银币挂机速度")
    难度系数[6] = f函数.读配置(程序目录.."定制难度.ini","定制任务","中级银币挂机法防")
  elseif self.战斗类型 == 100157 then --高级银币挂机
    难度系数[1] = f函数.读配置(程序目录.."定制难度.ini","定制任务","高级银币挂机气血")
    难度系数[2] = f函数.读配置(程序目录.."定制难度.ini","定制任务","高级银币挂机伤害")
    难度系数[3] = f函数.读配置(程序目录.."定制难度.ini","定制任务","高级银币挂机防御")
    难度系数[4] = f函数.读配置(程序目录.."定制难度.ini","定制任务","高级银币挂机灵力")
    难度系数[5] = f函数.读配置(程序目录.."定制难度.ini","定制任务","高级银币挂机速度")
    难度系数[6] = f函数.读配置(程序目录.."定制难度.ini","定制任务","高级银币挂机法防")
  elseif self.战斗类型 == 100158 then --超级银币挂机
    难度系数[1] = f函数.读配置(程序目录.."定制难度.ini","定制任务","超级银币挂机气血")
    难度系数[2] = f函数.读配置(程序目录.."定制难度.ini","定制任务","超级银币挂机伤害")
    难度系数[3] = f函数.读配置(程序目录.."定制难度.ini","定制任务","超级银币挂机防御")
    难度系数[4] = f函数.读配置(程序目录.."定制难度.ini","定制任务","超级银币挂机灵力")
    难度系数[5] = f函数.读配置(程序目录.."定制难度.ini","定制任务","超级银币挂机速度")
    难度系数[6] = f函数.读配置(程序目录.."定制难度.ini","定制任务","超级银币挂机法防")
  elseif self.战斗类型 == 100159 then --初级活跃挂机
    难度系数[1] = f函数.读配置(程序目录.."定制难度.ini","定制任务","初级活跃挂机气血")
    难度系数[2] = f函数.读配置(程序目录.."定制难度.ini","定制任务","初级活跃挂机伤害")
    难度系数[3] = f函数.读配置(程序目录.."定制难度.ini","定制任务","初级活跃挂机防御")
    难度系数[4] = f函数.读配置(程序目录.."定制难度.ini","定制任务","初级活跃挂机灵力")
    难度系数[5] = f函数.读配置(程序目录.."定制难度.ini","定制任务","初级活跃挂机速度")
    难度系数[6] = f函数.读配置(程序目录.."定制难度.ini","定制任务","初级活跃挂机法防")
  elseif self.战斗类型 == 100160 then --低级活跃挂机
    难度系数[1] = f函数.读配置(程序目录.."定制难度.ini","定制任务","低级活跃挂机气血")
    难度系数[2] = f函数.读配置(程序目录.."定制难度.ini","定制任务","低级活跃挂机伤害")
    难度系数[3] = f函数.读配置(程序目录.."定制难度.ini","定制任务","低级活跃挂机防御")
    难度系数[4] = f函数.读配置(程序目录.."定制难度.ini","定制任务","低级活跃挂机灵力")
    难度系数[5] = f函数.读配置(程序目录.."定制难度.ini","定制任务","低级活跃挂机速度")
    难度系数[6] = f函数.读配置(程序目录.."定制难度.ini","定制任务","低级活跃挂机法防")
  elseif self.战斗类型 == 100161 then --中级活跃挂机
    难度系数[1] = f函数.读配置(程序目录.."定制难度.ini","定制任务","中级活跃挂机气血")
    难度系数[2] = f函数.读配置(程序目录.."定制难度.ini","定制任务","中级活跃挂机伤害")
    难度系数[3] = f函数.读配置(程序目录.."定制难度.ini","定制任务","中级活跃挂机防御")
    难度系数[4] = f函数.读配置(程序目录.."定制难度.ini","定制任务","中级活跃挂机灵力")
    难度系数[5] = f函数.读配置(程序目录.."定制难度.ini","定制任务","中级活跃挂机速度")
    难度系数[6] = f函数.读配置(程序目录.."定制难度.ini","定制任务","中级活跃挂机法防")
  elseif self.战斗类型 == 100162 then --高级活跃挂机
    难度系数[1] = f函数.读配置(程序目录.."定制难度.ini","定制任务","高级活跃挂机气血")
    难度系数[2] = f函数.读配置(程序目录.."定制难度.ini","定制任务","高级活跃挂机伤害")
    难度系数[3] = f函数.读配置(程序目录.."定制难度.ini","定制任务","高级活跃挂机防御")
    难度系数[4] = f函数.读配置(程序目录.."定制难度.ini","定制任务","高级活跃挂机灵力")
    难度系数[5] = f函数.读配置(程序目录.."定制难度.ini","定制任务","高级活跃挂机速度")
    难度系数[6] = f函数.读配置(程序目录.."定制难度.ini","定制任务","高级活跃挂机法防")
  elseif self.战斗类型 == 100163 then --超级活跃挂机
    难度系数[1] = f函数.读配置(程序目录.."定制难度.ini","定制任务","超级活跃挂机气血")
    难度系数[2] = f函数.读配置(程序目录.."定制难度.ini","定制任务","超级活跃挂机伤害")
    难度系数[3] = f函数.读配置(程序目录.."定制难度.ini","定制任务","超级活跃挂机防御")
    难度系数[4] = f函数.读配置(程序目录.."定制难度.ini","定制任务","超级活跃挂机灵力")
    难度系数[5] = f函数.读配置(程序目录.."定制难度.ini","定制任务","超级活跃挂机速度")
    难度系数[6] = f函数.读配置(程序目录.."定制难度.ini","定制任务","超级活跃挂机法防")
  elseif self.战斗类型 == 100141 then --提升全服经验20
    难度系数[1] = f函数.读配置(程序目录.."定制难度.ini","定制任务","提升全服经验20气血")
    难度系数[2] = f函数.读配置(程序目录.."定制难度.ini","定制任务","提升全服经验20伤害")
    难度系数[3] = f函数.读配置(程序目录.."定制难度.ini","定制任务","提升全服经验20防御")
    难度系数[4] = f函数.读配置(程序目录.."定制难度.ini","定制任务","提升全服经验20灵力")
    难度系数[5] = f函数.读配置(程序目录.."定制难度.ini","定制任务","提升全服经验20速度")
    难度系数[6] = f函数.读配置(程序目录.."定制难度.ini","定制任务","提升全服经验20法防")
  elseif self.战斗类型 == 100142 then --提升全服经验50
    难度系数[1] = f函数.读配置(程序目录.."定制难度.ini","定制任务","提升全服经验50气血")
    难度系数[2] = f函数.读配置(程序目录.."定制难度.ini","定制任务","提升全服经验50伤害")
    难度系数[3] = f函数.读配置(程序目录.."定制难度.ini","定制任务","提升全服经验50防御")
    难度系数[4] = f函数.读配置(程序目录.."定制难度.ini","定制任务","提升全服经验50灵力")
    难度系数[5] = f函数.读配置(程序目录.."定制难度.ini","定制任务","提升全服经验50速度")
    难度系数[6] = f函数.读配置(程序目录.."定制难度.ini","定制任务","提升全服经验50法防")
  elseif self.战斗类型 == 100143 then --提升全服经验100
    难度系数[1] = f函数.读配置(程序目录.."定制难度.ini","定制任务","提升全服经验100气血")
    难度系数[2] = f函数.读配置(程序目录.."定制难度.ini","定制任务","提升全服经验100伤害")
    难度系数[3] = f函数.读配置(程序目录.."定制难度.ini","定制任务","提升全服经验100防御")
    难度系数[4] = f函数.读配置(程序目录.."定制难度.ini","定制任务","提升全服经验100灵力")
    难度系数[5] = f函数.读配置(程序目录.."定制难度.ini","定制任务","提升全服经验100速度")
    难度系数[6] = f函数.读配置(程序目录.."定制难度.ini","定制任务","提升全服经验100法防")
  elseif self.战斗类型 == 100140 then --单人闯关
    难度系数[1] = f函数.读配置(程序目录.."定制难度.ini","定制任务","单人闯关气血")
    难度系数[2] = f函数.读配置(程序目录.."定制难度.ini","定制任务","单人闯关伤害")
    难度系数[3] = f函数.读配置(程序目录.."定制难度.ini","定制任务","单人闯关防御")
    难度系数[4] = f函数.读配置(程序目录.."定制难度.ini","定制任务","单人闯关灵力")
    难度系数[5] = f函数.读配置(程序目录.."定制难度.ini","定制任务","单人闯关速度")
    难度系数[6] = f函数.读配置(程序目录.."定制难度.ini","定制任务","单人闯关法防")
  end
...
function 战斗处理类:添加技能属性(单位,技能组)
  for n=1,#技能组 do
    local 名称=技能组[n]
    if 名称=="上古灵符" or 名称=="月光" or 名称=="死亡召唤" or 名称=="法术防御" or 名称=="剑荡四方" or 名称=="天降灵葫" or 名称=="八凶法阵" or 名称=="观照万象" or 名称=="叱咤风云" or 名称=="自爆" or 名称=="水攻" or 名称=="落岩" or 名称=="雷击" or 名称=="烈火" or 名称=="地狱烈火" or 名称=="奔雷咒" or 名称=="水漫金山" or 名称=="泰山压顶" or 名称=="善恶有报" or 名称=="壁垒击破" or 名称=="惊心一剑" or 名称=="夜舞倾城" or 名称=="力劈华山" then
      单位.主动技能[#单位.主动技能+1]={名称=名称,等级=单位.等级}
      if 名称 == "叱咤风云" then
        if 单位.法连 == nil then
          单位.法连=10
    ...
    elseif 名称=="津津有味" or 名称=="津津有味" then
      if 名称=="津津有味" then
        if self:取技能重复(单位,"津津有味")==false then
          单位.必杀=单位.必杀+50
          单位.已加技能[#单位.已加技能+1]=名称
        end
      else
        单位.必杀=单位.必杀+50
        单位.已加技能[#单位.已加技能+1]="津津有味"
      end
...
function 战斗处理类:结算处理()
  local 死亡计算={0,0}
  for n=1,#self.参战单位 do
    if self.参战单位[n].气血<=0 or self.参战单位[n].捕捉 or self.参战单位[n].逃跑 or ( self.战斗类型==100167 and self.回合数 >=6 ) then
      if self.参战单位[n].队伍==self.队伍区分[1] then
        死亡计算[1]=死亡计算[1]+1
      else
        死亡计算[2]=死亡计算[2]+1
...
function 战斗处理类:取封印人数()  --封超过4个自动解封
  self.当前封印人数=0
  for n=1,#self.参战单位 do
    if self:取封印状态(n) then
       self.当前封印人数= self.当前封印人数 +1
      if self.当前封印人数 > 4 then
        for n=1,#self.参战单位 do
          local 状态名称={}
          状态名称=self:解除状态结果(self.参战单位[n],self:取异常状态法术())
          --self.战斗流程[#self.战斗流程]={流程=60,攻击方=编号,挨打方={挨打方=self.参战单位[n],解除状态={}}}
          --self.战斗流程[#self.战斗流程].取消状态=状态名称
          --self.参战单位[n].解除状态=状态名称
        end
      end
    end
  end
...
function 战斗处理类:设置执行回合()  --走这里
  ...
  for n=1,#self.参战单位 do
    ...
    elseif self.参战单位[n].灵动特性 ~= nil and self.参战单位[n].灵动次数 <3 and 取随机数() <= self.参战单位[n].灵动特性*5 then
      ...
      self.战斗发言数据[#self.战斗发言数据+1]={id=n,内容=self.参战单位[临时友方].名称.."雷霆嘎巴！！#24"}
    end
    ...
    elseif self.参战单位[n].队伍==0 and self.参战单位[n].捉鬼变异 and self.回合数==2 then
      ...
      self.参战单位[n].指令.目标= 0
      self.参战单位[n].指令.参数=""
    --elseif self.战斗类型==100167 and self.回合数 >=5 then
    --  self.参战单位[n].指令.下达=true
    --  self.参战单位[n].指令.类型="法术"
    -- self.参战单位[n].指令.目标= self:取单个敌方目标(n)
    --  self.参战单位[n].指令.参数="自爆"
...
function 战斗处理类:执行计算()
  for n=1,#self.参战单位 do
      if self.战斗类型==100170  then
        if  self.参战单位[n].分类=="野怪" or self.参战单位[n].分类=="变异" or self.参战单位[n].分类=="宝宝" then
          local 提升倍数 = 0.2
          self.参战单位[n].伤害=self.参战单位[n].伤害+self.参战单位[n].伤害 * 提升倍数
          self.参战单位[n].命中=self.参战单位[n].命中+self.参战单位[n].命中 * 提升倍数
          self.参战单位[n].灵力=self.参战单位[n].灵力+self.参战单位[n].灵力 * 提升倍数
          self.参战单位[n].法防=self.参战单位[n].法防+self.参战单位[n].法防 * 提升倍数
          self.参战单位[n].防御=self.参战单位[n].防御+self.参战单位[n].防御 * 提升倍数
          self.参战单位[n].气血=self.参战单位[n].气血+self.参战单位[n].气血 * 提升倍数
          self.参战单位[n].最大气血=self.参战单位[n].最大气血+self.参战单位[n].最大气血 * 提升倍数
        end
      end
      ...
      if self.参战单位[n] ~= nil and self.参战单位[n].法术状态 ~=nil and self.参战单位[n].法术状态.普渡众生~=nil then
        ...
        if self.参战单位[n].法术状态.尸腐毒~=nil then
          if self:取目标状态(n,n,2) then
            -- self:增加魔法(n,qz(self.参战单位[n].法术状态.炼气化神.等级/2))
            local 气血=qz(self.参战单位[n].气血*0.02)
            if self.参战单位[n].蚩尤元神~=nil and self.参战单位[n].蚩尤元神~=0 then
               气血=qz(self.参战单位[n].气血*0.05)
            end
              ...
              if self:取指定法宝境界(编号,"九幽")>=0 then
                ...
                for i=1,目标数 do
                  ...
                  if 释怀定制 then
                    ...
                    气血=qz(self.战斗流程[#self.战斗流程].气血*0.0005*法宝层数)
                    if self.参战单位[编号].蚩尤元神~=nil and self.参战单位[编号].蚩尤元神==2 then
                       气血=qz(self.战斗流程[#self.战斗流程].气血*0.001*法宝层数)
                    end
                  end
      ...
      --if self.参战单位[n].法术状态.诡蝠之刑~=nil then
      --  if self:取目标状态(n,n,2) then
      --    local 气血=qz(self.参战单位[n].法术状态.诡蝠之刑.等级*10)
      --    if 气血<=1 then
      --       气血=1
      --    end
      --    self.战斗流程[#self.战斗流程+1]={流程=102,攻击方=n,气血=0,挨打方={}}
      ...
      if self.参战单位[编号].指令.下达 then
        ...
        if self.参战单位[编号].指令.类型=="攻击" then--普通攻击
          ...
          if self:取攻击状态(self.执行对象[n]) then
            ...
            --if  self.参战单位[编号].追击效果 and self:取目标状态(self.执行对象[n],人物没打死,1)== false then
            --    self.参战单位[self.执行对象[n]].指令.目标= self:取单个敌方目标(编号)
            --    self:普通攻击计算(self.执行对象[n],1)
            --end

            if (必杀  or 怒击) and self:取攻击状态(self.执行对象[n])  then
              if #self.参战单位[编号].追加法术>0 and 取随机数()<=100+self.参战单位[编号].套装追加概率 and self:取攻击状态(self.执行对象[n]) and self:取奇经八脉是否有(编号,"逐胜") == false then
            ...
            elseif self.参战单位[目标1]~=nil and self.参战单位[编号].连击~=nil and self.参战单位[编号].连击>=取随机数() then
              ...
              if   self.参战单位[编号].追击效果 and self:取目标状态(self.执行对象[n],self.参战单位[self.执行对象[n]].指令.目标,3) and self:取攻击状态(self.执行对象[n]) then
                if #self.参战单位[编号].追加法术>0 and 取随机数()<=100+self.参战单位[编号].套装追加概率 and self:取攻击状态(self.执行对象[n]) then
                  self.参战单位[编号].指令.类型="法术"
                  self.参战单位[编号].指令.参数=self.参战单位[编号].追加法术[取随机数(1,#self.参战单位[编号].追加法术)].名称
                  self:法术计算(self.执行对象[n],1)
                end
        ...
        elseif self.参战单位[编号].指令.类型=="法术" then--法术攻击
          ...
          if 装备特技[self.参战单位[编号].指令.参数]==nil and self:取法术状态(self.执行对象[n]) or (装备特技[self.参战单位[编号].指令.参数]~=nil and self:取特技状态(self.执行对象[n])) then
            ...
            if 名称=="观照万象" then
              ...
              if self.参战单位[编号].类型=="角色" then
                常规提示(self.参战单位[编号].玩家id,"#Y/玩家不能使用观照万象技能")
              elseif self.参战单位[编号].观照万象 ~= nil then
...
function 战斗处理类:法术计算(编号)
  ...
  elseif self:法攻技能(名称) then
    ...
    if self.参战单位[编号].蚩尤元神~=nil and  名称=="龙卷雨击" and self.参战单位[编号].蚩尤元神==1 then
      if self.参战单位[编号].法连==nil then
         self.参战单位[编号].法连=30
      else
    ...
    if self.参战单位[编号].蚩尤元神~=nil and  self.参战单位[编号].门派=="龙宫" and self.参战单位[编号].蚩尤元神==2 then
      if self.参战单位[编号].法连==nil then
         self.参战单位[编号].法连=50
      else
        self.参战单位[编号].法连=self.参战单位[编号].法连+50
      end
    end
...
function 战斗处理类:恢复技能计算(编号,名称,等级)
  ...
  if 名称~="我佛慈悲" and 名称 ~= "慈航普渡"  and 名称~="杨柳甘露" and 名称~="起死回生" and 名称~="回魂咒" and 名称~="还阳术" and 名称~="莲花心音" and 名称~="由己渡人" then
      ...
      if 名称=="驱尸" or 名称=="解毒" or 名称=="清心" or 名称=="百毒不侵" then
       ...
       elseif 名称=="命疗术"  then
        ...
        elseif 名称=="星月之惠" then
          ...
          self.战斗流程[#self.战斗流程].挨打方[n].恢复气血=气血
        elseif 名称=="推气过宫" then
          if self.参战单位[编号].蚩尤元神~=nil and  self.参战单位[编号].蚩尤元神~=0 then
            气血=qz((等级*2+200)*(1-目标数*0.02)*1.5)
          else
        ...
        elseif 名称=="地涌金莲" then
          if self.参战单位[编号].蚩尤元神~=nil and self.参战单位[编号].蚩尤元神==2 then
            气血=qz((等级*2+100)*(1-目标数*0.15)*6)
          else
            气血=qz((等级*2+100)*(1-目标数*0.15)*3)
          end
...
function 战斗处理类:取固伤结果(编号,伤害)
  ...
  if self.参战单位[编号].凤舞九天~=nil and self.参战单位[编号].凤舞九天 ~= 0 then
...
function 战斗处理类:法攻技能计算1(编号,名称,等级,目标,目标数,执行数,伤害系数)
  ...
  elseif 名称=="五雷轰顶" then
    if 取随机数()<=50 then
      基础伤害=self.参战单位[目标].气血*0.2
    else
      基础伤害=self.参战单位[目标].气血*0.1
    end
    if self.参战单位[目标].蚩尤元神~=nil and self.参战单位[目标].蚩尤元神~=2 then
      基础伤害=基础伤害*2
    end
  ...
  elseif 名称=="龙吟" then
    基础伤害=等级+15
    基础伤害=self:取固伤结果(编号,基础伤害)*10
    if 编号~=nil and self:取奇经八脉是否有(编号,"清吟") then
        self:减少气血(目标,取随机数(500,1000))
    end
    self.战斗流程[#self.战斗流程].流程=205
  elseif 名称=="腾雷" then
    法伤系数=1.35
  ...
  elseif 名称=="靛沧海" then
    ...
    if self:取指定法宝(编号,"金刚杵",1) then
      基础伤害=基础伤害+qz(self:取指定法宝境界(编号,"金刚杵")*0.05)*基础伤害
    end
  ...
  elseif 名称=="三昧真火" then
    法伤系数=1.5
    if 编号~=nil and self:取奇经八脉是否有(编号,"赤暖") and 取随机数() <= 100 then
      local 气血 = qz(基础伤害/50)
        self:增加气血(编号,气血)
    end
  ...
  elseif 名称=="血雨" then
    ...
    self:减少气血(编号,结尾气血)
  elseif 名称=="天罗地网" then
    基础伤害=等级*3+self.参战单位[编号].伤害*20
    if self.参战单位[编号].蚩尤元神~=nil and self.参战单位[编号].蚩尤元神~=0 and self.参战单位[编号].固定伤害~=nil then
      基础伤害=基础伤害+self.参战单位[编号].固定伤害
    end
   ...
   elseif 名称=="阎罗令" then
    ...
    基础伤害=self:取固伤结果(编号,基础伤害)
    法伤系数=1-目标数*0.05
  --elseif 名称=="诡蝠之刑" then   --elseif 技能名称=="谜毒之缚" or 技能名称=="诡蝠之刑" or 技能名称=="怨怖之泣" then
  --  基础伤害=1
  --  法伤系数=1-目标数*0.05
   elseif 名称=="夺命咒" then
    基础伤害=等级*4+self.参战单位[编号].固定伤害
  ...
  if self.参战单位[编号].蚩尤元神~=nil and  名称=="落叶萧萧" and self.参战单位[编号].蚩尤元神==1 then
    法爆几率=法爆几率+30
    end
  if self.参战单位[编号].蚩尤元神~=nil and  self.参战单位[编号].门派=="神木林" and self.参战单位[编号].蚩尤元神==2 then
    法爆几率=法爆几率+50
  end
...
function 战斗处理类:增益技能计算(编号,名称,等级,附加,消耗,指定,境界)
  local 目标=self.参战单位[编号].指令.目标
  if 指定~=nil or 名称=="变身" or 名称=="楚楚可怜" or 名称=="灵刃" or 名称=="混元伞" or 名称=="干将莫邪" or 名称=="五彩娃娃" or 名称=="烈焰真诀" or 名称=="炎护" or 名称=="修罗隐身" or 名称=="分身术" or 名称=="不动如山" or 名称=="幻镜术" or 名称=="魔王回首" or 名称=="极度疯狂" or 名称=="神龙摆尾" or 名称=="杀气诀" or 名称=="安神诀" or 名称=="定心术" or 名称=="天魔解体" or 名称=="神龙摆尾" or 名称=="牛劲" then
    目标=编号
  end
...
function 战斗处理类:减益技能计算(编号,名称,等级)
 ...
 if self:技能消耗(self.参战单位[编号],1,名称,编号)==false then return  end
  self.执行等待=self.执行等待+10
   self.战斗流程[#self.战斗流程+1]={流程=56,攻击方=编号,挨打方={},提示={允许=true,类型="法术",名称=self.参战单位[编号].名称.."使用了"..名称}}
     self.战斗流程[#self.战斗流程].挨打方[1]={挨打方=目标,特效={名称}}
      if 名称=="尸腐毒" then
        local 气血=qz(self.参战单位[目标].气血*0.02)
        if self.参战单位[编号].蚩尤元神~=nil and self.参战单位[编号].蚩尤元神~=0 then
           气血=qz(self.参战单位[目标].气血*0.05)
        end
          ...
          if self:取指定法宝境界(编号,"九幽")>=0 then
            ...
            for i=1,目标数 do
              ...
              if 释怀定制 then
                ...
                气血=qz(self.战斗流程[#self.战斗流程].挨打方[1].气血*0.0005*法宝层数)
                if self.参战单位[编号].蚩尤元神~=nil and self.参战单位[编号].蚩尤元神==2 then
                   气血=qz(self.战斗流程[#self.战斗流程].挨打方[1].气血*0.001*法宝层数)
                end
              end
              气血=self:取恢复气血(编号,目标[i],气血)
              self:增加气血(目标[i],气血)
      ...
      elseif 名称=="诡蝠之刑" then
        ...
        目标=self:取多个敌方目标(编号,目标,目标数)
            ...
            self.战斗流程[#self.战斗流程].受益方 = {}
            for i=1,目标数 do
            self:添加状态(名称,self.参战单位[目标[i]],self.参战单位[编号],等级,编号)
            end
...
function 战斗处理类:物攻技能计算(编号,名称,等级)
  ...
  if 名称=="断岳势" and self.参战单位[编号].战意<1 then
    ...
    return
  elseif self.参战单位[编号].蚩尤元神~=nil and self.参战单位[编号].蚩尤元神~=2 and 名称=="天崩地裂" and self.参战单位[编号].战意<3 then
    self:添加提示(self.参战单位[编号].玩家id,编号,"#Y/你当前可使用的战意为#R/"..self.参战单位[编号].战意.."#Y/点，无法使用"..名称)
    return
  elseif self.参战单位[编号].蚩尤元神~=nil and self.参战单位[编号].蚩尤元神==2 and 名称=="天崩地裂" and self.参战单位[编号].战意<1 then
    self:添加提示(self.参战单位[编号].玩家id,编号,"#Y/你当前可使用的战意为#R/"..self.参战单位[编号].战意.."#Y/点，无法使用"..名称)
    return
  ...
  elseif 名称=="惊涛怒" and self.参战单位[编号].战意<1 then
    self:添加提示(self.参战单位[编号].玩家id,编号,"#Y/你当前可使用的战意为#R/"..self.参战单位[编号].战意.."#Y/点，无法使用"..名称)
    return
  elseif self.参战单位[编号].蚩尤元神~=nil and self.参战单位[编号].蚩尤元神~=2 and 名称=="翻江搅海" and self.参战单位[编号].战意<3 then
    self:添加提示(self.参战单位[编号].玩家id,编号,"#Y/你当前可使用的战意为#R/"..self.参战单位[编号].战意.."#Y/点，无法使用"..名称)
    return
  elseif self.参战单位[编号].蚩尤元神~=nil and self.参战单位[编号].蚩尤元神==2 and 名称=="翻江搅海" and self.参战单位[编号].战意<1 then
    self:添加提示(self.参战单位[编号].玩家id,编号,"#Y/你当前可使用的战意为#R/"..self.参战单位[编号].战意.."#Y/点，无法使用"..名称)
    return
  ...
  if self:技能消耗(self.参战单位[编号],目标数,名称,编号)==false then return  end
    ...
    elseif 名称=="天崩地裂" and self.参战单位[编号].战意>=3 then
      ...
      if self.参战单位[编号].蚩尤元神~=nil or self.参战单位[编号].蚩尤元神==2 then
        self.参战单位[编号].战意=self.参战单位[编号].战意-1
        战意提示=true
      end
      if self.参战单位[编号].蚩尤元神==nil then
        self.参战单位[编号].战意=self.参战单位[编号].战意-3
        战意提示=true
      end
    elseif 名称=="惊涛怒" and self.参战单位[编号].战意>=1 then
    ...
    elseif 名称=="浪涌" then
      if self.参战单位[编号].蚩尤元神~=nil and self.参战单位[编号].蚩尤元神~=0 then
        self.参战单位[编号].战意=self.参战单位[编号].战意+6
        战意提示=true
      end
      if self.参战单位[编号].蚩尤元神~=nil or self.参战单位[编号].蚩尤元神==0 then
        self.参战单位[编号].战意=self.参战单位[编号].战意+1
        战意提示=true
      end
      if self.参战单位[编号].蚩尤元神==nil then
    ...
    elseif 名称=="横扫千军" then
      ...
      if self.参战单位[编号].蚩尤元神~=nil and  self.参战单位[编号].蚩尤元神==1 then
        目标数=目标数+1
        结尾气血=qz(self.参战单位[编号].最大气血*0.2)
      end
      if self.参战单位[编号].蚩尤元神~=nil and  self.参战单位[编号].蚩尤元神==2 then
...
function 战斗处理类:添加状态(名称,攻击方,挨打方,等级,攻击编号,境界)
  ...
  local 编号=攻击编号
  if 名称=="横扫千军" then
    if 攻击编号~=nil and self:取奇经八脉是否有(攻击编号,"连破") and 取随机数(1,100)<=100 then
      回合=1
    else
      回合=2
    end
  ...
  elseif 名称=="变身"  then
    ...
    if 攻击方.蚩尤元神~=nil and 攻击方.蚩尤元神~=0 then
       回合=9999
    end
  elseif 名称=="反间之计"  then
    回合=qz(等级/30)+2
  ...
  elseif 名称=="娉婷嬝娜" then
    回合=qz(等级/40)+1
  elseif 名称=="日月乾坤" then
    if 攻击方.蚩尤元神~=nil and 攻击方.蚩尤元神==2 then
      回合=999
    end
    if 攻击方.蚩尤元神==nil or 攻击方.蚩尤元神~=2 then
      回合=qz(等级/35)+2
    end
  elseif 名称=="镇妖" then
    回合=qz(等级/35)+1
  ...
  elseif 名称=="气慑天军" then
    ...
    回合=999
    攻击方.抗物理暴击等级=攻击方.抗物理暴击等级+300
    攻击方.抗法术暴击等级=攻击方.抗法术暴击等级+300
  elseif 名称=="铜头铁臂" then
    回合=qz(等级/30)+1
    伤害=等级*1.5
    类型=2
...
function 战斗处理类:技能消耗(攻击方,数量,名称,编号)
  ...
  elseif self.技能名称=="长驱直入" or self.技能名称=="翩鸿一击" or self.技能名称=="妙悟" or self.技能名称=="烈焰真诀" then
    return self:魔法消耗(攻击方,50,1)
...
function 战斗处理类:取目标数量(攻击方,技能名称,等级,编号)
  ...
  elseif 技能名称=="鹰击" then
    ...
    if self.临时人数>=7 then self.临时人数=7 end
  ...
  elseif 技能名称=="雨落寒沙" or 技能名称=="飞花摘叶" or 技能名称=="唧唧歪歪" or 技能名称=="龙卷雨击" or 技能名称=="阎罗令" or 技能名称=="飞砂走石" or 技能名称=="生命之泉" then
   self.临时人数=math.floor(self.临时等级/25)+1
    ...
    if 技能名称=="龙卷雨击" and self:取奇经八脉是否有(编号,"龙魄") and 取随机数()<=100 then
        self.临时人数=self.临时人数+3
    end
    if 技能名称=="飞花摘叶" and self:取奇经八脉是否有(编号,"花殇") and 取随机数()<=10 then
        self.临时人数=self.临时人数+3
    end
    if 技能名称=="飞砂走石" and 编号~=nil and self:取奇经八脉是否有(编号,"震怒") and 取随机数()<=100 then
       self.临时人数=self.临时人数+3
    end
...
function 战斗处理类:恢复技能(名称)
  local 临时名称={"起死回生","回魂咒","无穷妙道","还阳术","舍身取义","活血","慈航普渡","地涌金莲","莲花心音","妙悟","星月之惠","玉清诀","净世煌火","晶清诀","冰清诀","水清诀","四海升平","命归术","气归术","凝神诀","凝气诀","命疗术","心疗术","气疗术","归元咒","乾天罡气","我佛慈悲","杨柳甘露","推拿","匠心·蓄锐","推气过宫","解毒","百毒不侵","宁心","解封","清心","驱魔","驱尸","寡欲令","复苏","由己渡人"}
 for n=1,#临时名称 do
...
function 战斗处理类:物攻技能(名称)
  local 临时名称={"剑荡四方","翻江搅海","破釜沉舟","惊涛怒","浪涌","猛击","百爪狂杀","鸿渐于陆","翩鸿一击","天命剑法","长驱直入","牛刀小试","天崩地裂","断岳势","裂石","满天花雨","破血狂攻","破碎无双","弱点击破","善恶有报","惊心一剑","壁垒击破","威震凌霄","横扫千军","狮搏","象形","连环击","鹰击","烟雨剑法","飘渺式","针锋相对","天雷斩","裂石","断岳势","天崩地裂","浪涌","惊涛怒","力劈华山","死亡召唤","夜舞倾城","高级连击","理直气壮"}
  for n=1,#临时名称 do
    if 临时名称[n]==名称 then return true end
  end
  return false
...
function 战斗处理类:普通攻击计算(编号,伤害比)
 ...
 --计算是否触发毒
  ...
  if self.参战单位[编号].追击效果 then
    return true
  end
  --if self.参战单位[编号].法术状态.诡蝠之刑~=nil then
  --  if self:取目标状态(编号,编号,2) then
  --    local 气血=qz(伤害值.伤害*1)
  --    if 气血<=1 then
  --      气血=1
  --    end
  --    self.战斗流程[#self.战斗流程+1]={流程=102,攻击方=编号,气血=0,挨打方={}}
...
function 战斗处理类:取灵力伤害(攻击方,挨打方,编号)
  ...
  if 释怀定制 and 攻击方.类型 == "角色" then
    ...
    伤害=((攻击方.灵力+攻击方.法术伤害+装备伤害)*(1+攻击方.法术修炼*0.02-挨打方.抗法修炼*0.02+法伤参数))-挨打方.法防-挨打方.法术防御
  end
...
function 战斗处理类:取伤害结果(攻击方,挨打方,伤害,暴击,保护) --如果保护存在 不触发神佑效果
  ...
  if self.战斗类型 == 100181 or self.战斗类型 == 100182 or self.战斗类型 == 100183 then
    if self.参战单位[攻击方]~=nil and self.参战单位[攻击方].帮派~=攻城数据.守城方.帮派名称 then
      伤害=伤害+qz(伤害*攻城数据.守城方.守城天数*0.5)
    end
  end
  return {伤害=伤害,类型=类型}
end
...
function 战斗处理类:取目标状态(攻击,挨打,类型)  --类型=1 为敌方正常 2为队友 3为复活队友
 --print(攻击,挨打,类型)
  if 类型==3 then
    if self.参战单位[挨打]==nil or self.参战单位[挨打].气血<=0  then
      return true
    else
      return false
    end
 ...
 for n=1,#self.参战玩家 do
  ...
  for n=1,#self.参战单位 do
    if self.参战单位[n].门派=="花果山" then
      ...
      if self.参战单位[n].蚩尤元神~=nil and self.参战单位[n].蚩尤元神==2 then
        self.随机神通={"神针撼海"}
      end
...
function 战斗处理类:结束战斗(胜利id,失败id,系统) --系统为不计算失败惩罚
  if 系统==nil then
    ...
    --if 失败id ~= nil then
    --   玩家数据[失败id].角色.数据.自动遇怪时间=os.time()
    --end
    --if 胜利id ~= nil then
    --   玩家数据[胜利id].角色.数据.自动遇怪时间=os.time()
    --end
  end
  self:还原单位属性()
  self:发送退出信息()
  ...
  if 胜利id~=0 then
     ...
     self.战斗胜利=true
      ...
      elseif self.战斗类型==100149 then
          任务处理类:初级经验挂机(self.任务id,id组)
      elseif self.战斗类型==100150 then
          任务处理类:低级经验挂机(self.任务id,id组)
      elseif self.战斗类型==100151 then
          任务处理类:中级经验挂机(self.任务id,id组)
      elseif self.战斗类型==100152 then
          任务处理类:高级经验挂机(self.任务id,id组)
      elseif self.战斗类型==100153 then
          任务处理类:超级经验挂机(self.任务id,id组)
      elseif self.战斗类型==100154 then
          任务处理类:初级银币挂机(self.任务id,id组)
      elseif self.战斗类型==100155 then
          任务处理类:低级银币挂机(self.任务id,id组)
      elseif self.战斗类型==100156 then
          任务处理类:中级银币挂机(self.任务id,id组)
      elseif self.战斗类型==100157 then
          任务处理类:高级银币挂机(self.任务id,id组)
      elseif self.战斗类型==100158 then
          任务处理类:超级银币挂机(self.任务id,id组)
      elseif self.战斗类型==100159 then
          任务处理类:初级活跃挂机(self.任务id,id组)
      elseif self.战斗类型==100160 then
          任务处理类:低级活跃挂机(self.任务id,id组)
      elseif self.战斗类型==100161 then
          任务处理类:中级活跃挂机(self.任务id,id组)
      elseif self.战斗类型==100162 then
          任务处理类:高级活跃挂机(self.任务id,id组)
      elseif self.战斗类型==100163 then
          任务处理类:超级活跃挂机(self.任务id,id组)
      elseif self.战斗类型==100141 then
          地图处理类:更新自定义怪(self.战斗类型,id组)
          任务处理类:提升经验倍数20(self.任务id,id组)
      elseif self.战斗类型==100142 then
          地图处理类:更新自定义怪(self.战斗类型,id组)
          任务处理类:提升经验倍数50(self.任务id,id组)
      elseif self.战斗类型==100143 then
          地图处理类:更新自定义怪(self.战斗类型,id组)
          任务处理类:提升经验倍数100(self.任务id,id组)
      elseif self.战斗类型==100140 then
          任务处理类:单人闯关(self.任务id,id组)
      elseif self.战斗类型==100179 then
          玩家数据[胜利id].角色.数据.蚩尤元神=2
          常规提示(胜利id,"#Y/恭喜你挑战蚩尤成功，获得高级蚩尤BUFF")
          elseif self.战斗类型==100166 then
          玩家数据[胜利id].角色.数据.化圣=1
          常规提示(胜利id,"#Y/恭喜你挑战化圣成功，去称谓大师领取称谓吧")
          elseif self.战斗类型==100168 then
          玩家数据[胜利id].角色.数据.小鸟伏特加=1
          常规提示(胜利id,"#Y/恭喜你挑战小鸟伏特加成功，去称谓大师领取称谓吧")
          elseif self.战斗类型==100172 then
          玩家数据[胜利id].角色.数据.成佛=1
          常规提示(胜利id,"#Y/恭喜你挑战成佛成功，去称谓大师领取称谓吧")
          elseif self.战斗类型==100174 then
          玩家数据[胜利id].角色.数据.无情哈拉少=1
          常规提示(胜利id,"#Y/恭喜你挑战无情哈拉少成功，去称谓大师领取称谓吧")
          elseif self.战斗类型==100178 then
          玩家数据[胜利id].角色.数据.化神=1
          常规提示(胜利id,"#Y/恭喜你挑战化神成功，去称谓大师领取称谓吧")
      elseif self.战斗类型==100181 then
          任务处理类:攻城木桩计算1(self.任务id,id组)
      elseif self.战斗类型==100182 then
          任务处理类:攻城木桩计算2(self.任务id,id组)
      elseif self.战斗类型==100183 then
          任务处理类:攻城木桩计算3(self.任务id,id组)
    ...
    elseif self.战斗类型==100049 then
      ...
      玩家数据[胜利id].角色:刷新任务跟踪()
    -- elseif self.战斗类型==100054 and 玩家数据[胜利id].角色.数据.剧情.飞升.飞升元宝跳过 == 0 then
    ...
    elseif self.战斗类型==100090 then
        ...
        玩家数据[胜利id].角色.数据.剧情点=玩家数据[胜利id].角色.数据.剧情点+20
...
function 战斗处理类:奖励事件(id)
 if self.战斗类型==100001 or self.战斗类型==100007 then
     ...
     玩家数据[id].角色:添加法宝灵气(id,1,self.等级下限,self.等级上限)
      ...
      if 老唐定制 then
        ...
        elseif 随机数<=99 then
          ...
          礼包奖励类:取随机装备(id,取随机数(6,12),"无级别限制")
        end
      else
    ...
    elseif self.战斗类型==100008 and 取任务符合id(id,self.任务id) then
      ...
      local 经验=qz(等级*20000*(玩家数据[id].角色.数据.捉鬼次数*0.2+1))
      local 银子=qz(等级*5000*(玩家数据[id].角色.数据.捉鬼次数*0.1+1))
      ...
      if 活跃数据[id].抓鬼次数>0 then
        ...
        玩家数据[id].角色.数据.累积活跃.总积分=玩家数据[id].角色.数据.累积活跃.总积分+2
    ...
    elseif self.战斗类型==100011 then
      ...
      local 经验=qz((等级*20000)*(1+(15-#任务数据[任务id1].闯关序列)*0.05))
      local 银子=qz(等级*5000)
      ...
      if 活跃数据[id].门派闯关次数>0 then
        ...
        常规提示(id,"#Y/你获得了"..名称)
        广播消息({内容=format("#S(门派闯关)#R/%s#Y在门派闯关活动表现优异，获得了门派护法奖励的#G/%s#Y".."#"..取随机数(1,110),玩家数据[id].角色.数据.名称,名称),频道="xt"})
        玩家数据[id].角色:添加元宝(1,"门派闯关",10)
        常规提示(id,"#Y/你获得了10元宝")
        广播消息({内容=format("#S(门派闯关)#Y/经过一番激烈的战斗，玩家：#R"..玩家数据[id].角色.数据.名称.."#Y获得了#R10元宝")})
        end
  ...
  elseif self.战斗类型==100023 then
    ...
    elseif self.战斗类型==100025 then
     ...
     local 等级=玩家数据[id].角色.数据.等级
     local 经验=qz(经验加成*等级*80000)
     local 银子=qz(银子加成*等级*100000)
  ...
  elseif self.战斗类型==100027 then
    ...
    local 奖励参数=取随机数()
      if 奖励参数<=15 then
        ...
        常规提示(id,"#Y/你获得了"..名称)
        广播消息({内容=format("#S(知了王)#R/%s#Y经过一番激烈的战斗，最终战胜了#R%s#Y，因此获得了其奖励的#G/%s#Y".."#"..取随机数(1,110),玩家数据[id].角色.数据.名称,任务数据[self.任务id].名称,名称),频道="xt"})
      elseif 奖励参数<=30 then
        local 名称="修炼果"
        玩家数据[id].道具:给予道具(id,名称,1)
        常规提示(id,"#Y/你获得了"..名称)
      ...
      elseif 奖励参数<=45 then
        local 名称="星辉石"
        玩家数据[id].道具:给予道具(id,名称,取随机数(12,13))
        常规提示(id,"#Y/你获得了"..名称)
        广播消息({内容=format("#S(知了王)#R/%s#Y经过一番激烈的战斗，最终战胜了#R%s#Y，因此获得了其奖励的#G/%s#Y".."#"..取随机数(1,110),玩家数据[id].角色.数据.名称,任务数据[self.任务id].名称,名称),频道="xt"})
      elseif 奖励参数<=60 then
        local 名称=取宝石()
        玩家数据[id].道具:给予道具(id,名称,取随机数(14,15))
        常规提示(id,"#Y/你获得了"..名称)
        广播消息({内容=format("#S(知了王)#R/%s#Y经过一番激烈的战斗，最终战胜了#R%s#Y，因此获得了其奖励的#G/%s#Y".."#"..取随机数(1,110),玩家数据[id].角色.数据.名称,任务数据[self.任务id].名称,名称),频道="xt"})
      elseif 奖励参数<=80 then
        local 名称="初级神魂丹"
      ...
      elseif 奖励参数<=100 then
        玩家数据[id].角色:添加元宝(3,"知了王",1)
        常规提示(id,"#Y/你获得了3元宝")
        广播消息({内容=format("#S(知了王)#Y/经过一番激烈的战斗，玩家：#R"..玩家数据[id].角色.数据.名称.."#Y获得了#R3元宝")})
      end
  elseif self.战斗类型==100028 then
      local 等级=取队伍平均等级(玩家数据[id].队伍,id)
  ...
  elseif self.战斗类型==100032 then--天庭叛逆
    ...
    elseif 奖励参数<=30 then
      local 名称="星辉石"
      玩家数据[id].道具:给予道具(id,名称,取随机数(10,12))
      常规提示(id,"#Y/你获得了"..名称)
      广播消息({内容=format("#S(天庭叛逆)#R/%s#Y经过一番激烈的战斗，最终战胜了叛逃的#R%s#Y，因此获得了其奖励的#G/%s#Y".."#"..取随机数(1,110),玩家数据[id].角色.数据.名称,任务数据[self.任务id].名称,名称),频道="xt"})
    elseif 奖励参数<=32 then
      玩家数据[id].角色:添加元宝(1,"天庭叛逆",1)
      常规提示(id,"#Y/你获得了1元宝")
      广播消息({内容=format("#S(天庭叛逆)#Y/经过一番激烈的战斗，玩家：#R"..玩家数据[id].角色.数据.名称.."#Y获得了#R1元宝")})
    end
  ...
  elseif self.战斗类型==100033 then--捣乱的水果
    ...
    elseif 奖励参数<=38 then
      ...
      广播消息({内容=format("#S(捣乱的水果)#R/%s#Y经过一番激烈的战斗，最终战胜了#R%s#Y，因此获得了其奖励的#G/%s#Y".."#"..取随机数(1,110),玩家数据[id].角色.数据.名称,任务数据[self.任务id].名称,名称),频道="xt"})
    elseif 奖励参数<=39 then
      玩家数据[id].角色:添加元宝(1,"捣乱的水果",1)
      常规提示(id,"#Y/你获得了1元宝")
      广播消息({内容=format("#S(捣乱的水果)#Y/经过一番激烈的战斗，玩家：#R"..玩家数据[id].角色.数据.名称.."#Y获得了#R1元宝")})
    end
  elseif self.战斗类型==100066 then
      local 等级=取队伍平均等级(玩家数据[id].队伍,id)
      local 经验=等级*400+30000
  ...
  for i=1,#id组 do
    if 玩家数据[id组[i]]~=nil then
      ...
      elseif self.战斗类型== 100167  then
        常规提示(id组[i],"#Y/第5回合结束没有打掉怪物，战斗失败！！")
...
function 战斗处理类:扣经验(失败id,倍率)
  if 倍率~=nil then
    self.扣除经验 = math.floor(玩家数据[失败id].角色.数据.当前经验 * 0.0000001)
  else
    self.扣除经验 = math.floor(玩家数据[失败id].角色.数据.当前经验 * 0.0000001)
  end
...
function 战斗处理类:扣银子(失败id,倍率)
  if 倍率~=nil then
    self.扣除银子 = math.floor(玩家数据[失败id].角色.数据.银子 * 0.0000001)
  else
    self.扣除银子 = math.floor(玩家数据[失败id].角色.数据.银子 * 0.0000001)
  end
...
function 战斗处理类:还原单位属性()
 for n=1,#self.参战单位 do
    if self.参战单位[n].气血<0 then self.参战单位[n].气血=0 end
    if self.参战单位[n].魔法<0 then self.参战单位[n].魔法=0 end
      if self.参战单位[n]~=nil and self.参战单位[n].队伍~=0 and self.参战单位[n].逃跑==nil and self.参战单位[n].系统队友==nil and 玩家数据[self.参战单位[n].玩家id]~=nil and self.参战单位[n].类型 ~=nil then --玩家数据[self.参战单位[n].玩家id]~=nil and self.参战单位[n].分类 ~= nil and self.参战单位[n].分类 ~= "野怪"  then
          if self.参战单位[n].类型=="角色" and self.参战单位[n].助战编号 == nil then
            if self.参战单位[n].气血<=0 then
              玩家数据[self.参战单位[n].玩家id].角色:死亡处理()
              玩家数据[self.参战单位[n].玩家id].角色:刷新信息("1")
            ...
            if 玩家数据[self.参战单位[n].玩家id].角色:取任务(10)~=0 and self.战斗类型 ~= 100050 and self.战斗类型 ~= 100051 and self.战斗类型 ~= 100052 and self.战斗类型 ~= 100053 and self.战斗类型 ~= 100130 and self.战斗类型 ~= 100131 and self.战斗类型 ~= 100132 and self.战斗类型 ~= 100133 and self.战斗类型 ~= 100164 and self.战斗类型 ~= 100165 and self.战斗类型 ~= 100166 and self.战斗类型 ~= 100167 and self.战斗类型 ~= 100168 and self.战斗类型 ~= 100169 and self.战斗类型 ~= 100170 and self.战斗类型 ~= 100171 and self.战斗类型 ~= 100172 and self.战斗类型 ~= 100173 and self.战斗类型 ~= 100174 and self.战斗类型 ~= 100175 and self.战斗类型 ~= 100176 and self.战斗类型 ~= 100177 and self.战斗类型 ~= 100178 then
...
function 战斗处理类:经脉属性处理(编号)
  if self.参战单位[编号].奇经八脉 ~= nil then
    if 编号~=nil and (self:取奇经八脉是否有(编号,"额外能力大唐官府")or self:取奇经八脉是否有(编号,"额外能力化生寺") or self:取奇经八脉是否有(编号,"额外能力方寸山")or self:取奇经八脉是否有(编号,"额外能力女儿村")or self:取奇经八脉是否有(编号,"额外能力神木林")or self:取奇经八脉是否有(编号,"额外能力天机城")or self:取奇经八脉是否有(编号,"额外能力狮驼岭")or self:取奇经八脉是否有(编号,"额外能力魔王寨")or self:取奇经八脉是否有(编号,"额外能力阴曹地府")or self:取奇经八脉是否有(编号,"额外能力盘丝洞")or self:取奇经八脉是否有(编号,"额外能力无底洞")or self:取奇经八脉是否有(编号,"额外能力女魃墓")or self:取奇经八脉是否有(编号,"额外能力凌波城")or self:取奇经八脉是否有(编号,"额外能力五庄观")or self:取奇经八脉是否有(编号,"额外能力花果山")or self:取奇经八脉是否有(编号,"额外能力普陀山")or self:取奇经八脉是否有(编号,"额外能力龙宫")or self:取奇经八脉是否有(编号,"额外能力天宫"))then
...
function 战斗处理类:发送退出信息()
  for n=1,#self.参战玩家 do
      ...
      if 玩家数据[self.参战玩家[n].id]~=nil then
        ...
        if 玩家数据[self.参战玩家[n].id].角色.数据.自动挂机~= 0 then
          玩家数据[self.参战玩家[n].id].角色.数据.自动遇怪时间=os.time()
        end
  ...
  if self.战斗类型==100164 and self.战斗失败==false then
    local id=self.进入战斗玩家id
    战斗准备类:创建战斗(id,100165,self.任务id)
  elseif self.战斗类型==100165 and self.战斗失败==false then
    local id=self.进入战斗玩家id
    战斗准备类:创建战斗(id,100166,self.任务id)
  end
  if self.战斗类型==100167 and self.战斗失败==false then
    local id=self.进入战斗玩家id
    战斗准备类:创建战斗(id,100168,self.任务id)
  end
  if self.战斗类型==100170 and self.战斗失败==false then
    local id=self.进入战斗玩家id
    战斗准备类:创建战斗(id,100171,self.任务id)
  elseif self.战斗类型==100171 and self.战斗失败==false then
    local id=self.进入战斗玩家id
    战斗准备类:创建战斗(id,100172,self.任务id)
  end
  if self.战斗类型==100173 and self.战斗失败==false then
    local id=self.进入战斗玩家id
    战斗准备类:创建战斗(id,100174,self.任务id)
  end
  if self.战斗类型==100176 and self.战斗失败==false then
    local id=self.进入战斗玩家id
    战斗准备类:创建战斗(id,100177,self.任务id)
  elseif self.战斗类型==100177 and self.战斗失败==false then
    local id=self.进入战斗玩家id
    战斗准备类:创建战斗(id,100178,self.任务id)
  end
