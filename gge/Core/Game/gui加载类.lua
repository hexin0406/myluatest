...
-- @最后修改来自: baidwwy
-- @Last Modified time: 2019-11-08 16:37:34
local __ggeGuiLoader = require("ggeguiloader")
local GUI加载类 = class()
...
function GUI加载类:创建控件(类名,指针)
	local ctrl = require("gui控件类")(self.load:CreateControl(类名))
