...
-- @最后修改来自: baidwwy
-- @Last Modified time: 2020-05-10 12:25:31
...
ffi.cdef[[
	...
	const char* Csfh(const char *qq);
]]
local advapi32 = ffi.load("advapi32.dll")
local fun = {}

function fun.修改窗口图标(文件)
...
function fun.信息框(msg,title,type)
...
--print(fun.读注册表(0x80000002,'SOFTWARE\\Wow6432Node\\AskTao','AppPath'))
