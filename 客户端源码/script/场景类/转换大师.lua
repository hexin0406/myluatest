-- @作者: baidwwy
-- @邮箱:  313738139@qq.com
-- @创建时间:   2020-08-31 21:55:04
-- @最后修改来自: baidwwy
-- @Last Modified time: 2020-09-01 11:05:17
--======================================================================--
-- @作者: GGE研究群: 342119466
-- @创建时间:   2018-03-03 02:34:19
-- @Last Modified time: 2020-08-30 16:13:11
--======================================================================--
local 场景类_转换大师道具栏 = class()
...
function 场景类_转换大师道具栏:更新(dt,x,y)

 self.鼠标=self:检查点(x,y)
end
function 场景类_转换大师道具栏:取可用道具(名称,物品)


end
function 场景类_转换大师道具栏:显示(dt,x,y)
	if not self.可视 then
		return false
	end
	self.焦点 = false
	...
	zts1:显示(self.x+125,self.y+3,"转换大师")
