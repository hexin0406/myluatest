...
-- @Last Modified time: 2020-06-04 20:26:19
--======================================================================--
...
function 场景类_队伍阵型栏:打开(数据)
	if self.可视 then
		...
		self.资源组 = {
			...
			[17] = 自适应.创建(1,1,449,18,1,3,nil,18)
		}
		for n=3,13 do
...
function 场景类_队伍阵型栏:显示(dt,x,y)
	...
	self.资源组[17]:显示(self.x+6,self.y+3)
	self.资源组[16]:显示(self.x + 15,self.y + 85)
	tp.窗口标题背景_:置区域(0,0,74,16)
	tp.窗口标题背景_:显示(self.x+202,self.y+3)
	zts1:置字间距(2)
	zts1:显示(self.x+208,self.y+3,"阵型选择")
	zts1:置字间距(0)
	self.资源组[2]:显示(self.x + 460,self.y + 6)
