...
-- @最后修改来自: baidwwy
-- @Last Modified time: 2020-07-08 11:17:20
--<<=========================================================================================>>--
...
function ggeobj:显示(x,y,bz)
	if bz == nil then
		bz = 1
	end
	if(self._isok)then
		self.x,self.y = x or 0,y or 0
		self._obj:SetPosition(self.x*bz,self.y*bz)
		self._obj:SetPositionEx(self.x*bz,self.y*bz,0,self.xx*bz,self.xy*bz)
		self._obj:Render()
		self._userpos = false
	end
	return self
