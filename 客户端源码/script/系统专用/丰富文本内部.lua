...
-- @最后修改来自: baidwwy
-- @Last Modified time: 2020-02-17 01:14:42
local 丰富文本类 = class()
...
function 丰富文本类:初始化(...)
	...
	self.行间距 		= 1
	self.元素表 		= {P=0xFFFF1493,W=0xFFFFFFFF,H=0xFF000000,Y=0xFFFFFF00,L=-16776961,R=4294901760,G=4278255360,S=-16466190,Z=-16711681,N=-16777216,C=ARGB(255,125,125,125)}
	self.显示表 		= {高度 = 0,宽度 = 0}
