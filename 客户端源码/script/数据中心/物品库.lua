...
-- @Last Modified time: 2020-09-16 00:05:34
--======================================================================--
function 引擎.取物品(wd)   ---2是总类,3是分类,4子类
	local wds = {}
	-- 重做数据1.2
	-- 任务
	if wd == "避火诀" then
  ...
  elseif wd == "蓝色合成旗" then
   ...
   elseif wd == "黄色合成旗" then
	...
	elseif wd == "一倍经验丹" then
		wds[1] = "基础经验额外增加1倍,可以与双倍、精修、双倍经验丹同时存在,每次使用获得10小时有效时间。无法冻结、无法叠加使用。"
		wds[2] = 4
		wds[3] = 2
		wds[4] = 0
	    wds[11] = "item.wd1"
	...
	elseif wd == "双倍经验丹" then
		wds[1] = "基础经验额外增加2倍,可以与双倍、精修、双倍经验丹同时存在,每次使用获得10小时有效时间。无法冻结、无法叠加使用。"
		wds[2] = 4
		wds[3] = 2
		wds[4] = 0
	    wds[11] = "item.wd1"
...
elseif wd == "竹林熊猫" then
	...
	elseif wd == "华风汉雅" then
		wds[1] = "越罗衫袂迎春风，玉刻麒麟腰带红。绣罗衣裳华风曲，汉雅无双真国色（有战斗锦衣）。"
		wds[2] = 2
		wds[3] = 15
		wds[4] = 1
		wds[5] = 60
	...
	elseif wd == "夜影" then
	    ...
	    wds[13] = 0xFFED8419
	elseif wd == "夏日清凉" then
		wds[1] = "夏日专属的清凉套装，穿着上，一起享受美好的夏日时光（有战斗锦衣）。"
		wds[2] = 2
		wds[3] = 15
		wds[4] = 1
		wds[5] = 60
...
----三级符石----
	...
	elseif wd == "宝贝葫芦" then
	    ...
	    wds[13] = 0x2CE03BE9
	elseif wd == "神气小龟" then
		wds[1] = "购买后获得1.3坐骑一只，只能 偃无师 鬼潇潇 桃夭夭 骑乘"
		wds[2] = "普通礼包"
		wds[3] = 3
		wds[4] = 0
	    wds[11] = "item.wdf"
