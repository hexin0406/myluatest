...
-- @Last Modified time: 2021-01-27 02:06:28
...
function 引擎.取技能(jn)
	...
	elseif jn == "强化物理防御" then
		...
		jns[7] = 0x00000003
		jns[8] = 0x00000003
	elseif jn == "提升战斗加速" then
		jns[1] = "提升战斗过程中的动画速度 等级*2%"
		jns[3] = 8
		jns[6] = "wzife.wd2"
		jns[7] = 0x00000011
		jns[8] = 0x00000011
  ...
  elseif jn == "破碎无双" then
	...
	elseif jn == "魔冥" then
		...
		jns[8] = 0x8BF70190
	elseif jn == "燃魂" then
		jns[1] = "#W//增加当前魔法#W//魔法上限*50的法术伤害力、抗封等级。"
		jns[3] = 8
		jns[6] = "wzife.wd2"
		jns[7] = 0x79602FB7
		jns[8] = 0x79602FB7
	...
	elseif jn == "破击" then
		...
		jns[8] = 0x6E010D11
	elseif jn == "怒涛" then
		jns[1] = "浪涌，惊涛怒，翻江搅海的每一次攻击有70%几率降低目标人物自身等级#W//2的防御，持续2回合。"
		jns[3] = 8
		jns[6] = "wzife.wd4"
		jns[7] = 0xE971301E
		jns[8] = 0xE971301E
	...
	elseif jn == "焕然" then
		...
		jns[8] = 0x00000238
	elseif jn == "伤蚀" then
		jns[1] = "你的怨灵#W//幻魔攻击时，有100%概率使目标获得随机诅咒。"
		jns[3] = 8
		jns[6] = "wzife.wd2"
		jns[7] = 0x00000239
		jns[8] = 0x00000239
	...
	elseif jn == "极天炼焰" then
		...
		jns[8] = 0X00000166
	elseif jn == "谜毒之缚" then
		jns[1] = "梦魇化为毒魅紧紧盘绕对手，使之无法呼吸，使目标造成的伤害和治疗降低，可叠加6层，作用目标数=技能等级#W//40+1，最多5个。"
		jns[3] = 4
		...
		jns[8] = 0X00000173
	elseif jn == "诡蝠之刑" then
		jns[1] = "诡蝠振翅，阴风缭绕，见之皆毛骨悚然，使目标造成伤害时受到反噬，可叠加6层，作用目标数=技能等级#W//40+1，最多5个"
		jns[3] = 4
		jns[4] = "(30+10*作用目标数)点魔法"
		jns[5] = "“煌火无明”技能达到10级"
		jns[6] = "wzife.wd6"
		...
		jns[8] = 0X00000174
	elseif jn == "怨怖之泣" then
		jns[1] = "幽怨的哀哭绕梁不绝，令人魂悸而魄动，使目标增益状态更快消失，负面状态持续时间延长，可叠加6层，作用目标数=技能等级#W//40+1，最多5个"
		jns[3] = 4
		jns[4] = "(30+10*作用目标数)点魔法"
		jns[5] = "“煌火无明”技能达到30级"
		jns[6] = "wzife.wd6"
	...
	elseif jn == "唤灵·魂火" then
		jns[1] = "怨之极，为仇，为怒，化形为魂火，有燎发摧枯之能，召唤(技能等级#W//125+2)个怨灵"
		jns[3] = 66
		jns[4] = "30点魔法"
		jns[5] = "“化神以灵”技能达到1级"
		jns[6] = "wzife.wd6"
	...
	elseif jn == "腾云驾霧" then
		...
		jns[8] = 0X00000053
	elseif jn == "威震凌霄" then
		jns[1] = "灵霄宝殿惊玉皇，十万天军无可挡。被大圣选定的攻击目标，其勇气和攻势将大大减弱。对目标造成伤害，并降低目标物理#W//法术暴击等级。"
		jns[3] = 4
		jns[4] = "100点魔法"
		...
		jns[8] = 0X00000150
	elseif jn == "气慑天军" then
		jns[1] = "大闹天宫之际，虽有天军名将，仍震慑于大圣之气势，众人攻势均不能近其要害。对自己使用，大量提升抗物理#W//法术暴击等级。"
		jns[3] = 3
		jns[4] = "100点魔法"
		jns[5] = "“神通广大”技能达到120级且角色飞升。"
		jns[6] = "wzife.wd6"
	...
	elseif jn == "当头一棒" then
		...
		jns[8] = 0x00000136
	elseif jn == "神针撼海" then
		jns[1] = "神针撼动，东海倾波，龙宫不稳，海中生灵无一不处在你攻势的笼罩之下。对多个目标造成物理伤害。作用目标数=技能等级#W//35+1，最多5个。"
		jns[3] = 4
		jns[4] = "75点魔法"
		jns[5] = "“如意金箍”技能达到1级"
		jns[6] = "wzife.wd6"
	...
	elseif jn == "额外能力(大唐官府)" then
		jns[1] = "学习之后，伤害+%8 防御+%8 灵力+%8 法防+%8 速度+%8"
		jns[3] = 8
		jns[6] = "wzife.wd2"
		jns[7] = 0xA209C3C2
		jns[8] = 0xA209C3C2
	elseif jn == "额外能力(化生寺)" then
		jns[1] = "学习之后，伤害+%8 防御+%8 灵力+%8 法防+%8 速度+%8"
		jns[3] = 8
		jns[6] = "wzife.wd2"
		jns[7] = 0xA209C3C2
		jns[8] = 0xA209C3C2
	elseif jn == "额外能力(方寸山)" then
		jns[1] = "学习之后，伤害+%8 防御+%8 灵力+%8 法防+%8 速度+%8"
		jns[3] = 8
		jns[6] = "wzife.wd2"
		jns[7] = 0xA209C3C2
		jns[8] = 0xA209C3C2
	elseif jn == "额外能力(女儿村)" then
		jns[1] = "学习之后，伤害+%8 防御+%8 灵力+%8 法防+%8 速度+%8"
		jns[3] = 8
		jns[6] = "wzife.wd2"
		jns[7] = 0xA209C3C2
		jns[8] = 0xA209C3C2
	elseif jn == "额外能力(神木林)" then
		jns[1] = "学习之后，伤害+%8 防御+%8 灵力+%8 法防+%8 速度+%8"
		jns[3] = 8
		jns[6] = "wzife.wd2"
		jns[7] = 0xA209C3C2
		jns[8] = 0xA209C3C2
	elseif jn == "额外能力(天机城)" then
		jns[1] = "学习之后，伤害+%8 防御+%8 灵力+%8 法防+%8 速度+%8"
		jns[3] = 8
		jns[6] = "wzife.wd2"
		jns[7] = 0xA209C3C2
	...
	elseif jn == "额外能力(狮驼岭)" then
		jns[1] = "学习之后，伤害+%15 防御+%15 灵力+%5 法防+%15 速度+%5"
		jns[3] = 8
		jns[6] = "wzife.wd2"
		jns[7] = 0xA209C3C2
		jns[8] = 0xA209C3C2
	elseif jn == "额外能力(魔王寨)" then
		jns[1] = "学习之后，伤害+%15 防御+%15 灵力+%5 法防+%15 速度+%5"
		jns[3] = 8
		jns[6] = "wzife.wd2"
		jns[7] = 0xA209C3C2
		jns[8] = 0xA209C3C2
	elseif jn == "额外能力(阴曹地府)" then
		jns[1] = "学习之后，伤害+%15 防御+%15 灵力+%5 法防+%15 速度+%5"
		jns[3] = 8
		jns[6] = "wzife.wd2"
		jns[7] = 0xA209C3C2
		jns[8] = 0xA209C3C2
	elseif jn == "额外能力(盘丝洞)" then
		jns[1] = "学习之后，伤害+%15 防御+%15 灵力+%5 法防+%15 速度+%5"
		jns[3] = 8
		jns[6] = "wzife.wd2"
		jns[7] = 0xA209C3C2
		jns[8] = 0xA209C3C2
	elseif jn == "额外能力(无底洞)" then
		jns[1] = "学习之后，伤害+%15 防御+%15 灵力+%5 法防+%15 速度+%5"
		jns[3] = 8
		jns[6] = "wzife.wd2"
		jns[7] = 0xA209C3C2
		jns[8] = 0xA209C3C2
	elseif jn == "额外能力(女魃墓)" then
		jns[1] = "学习之后，伤害+%15 防御+%15 灵力+%5 法防+%15 速度+%5"
		jns[3] = 8
		jns[6] = "wzife.wd2"
		jns[7] = 0xA209C3C2
	...
	elseif jn == "额外能力(凌波城)" then
		jns[1] = "学习之后，伤害+%5 防御+%15 灵力+%15 法防+%15 速度+%5"
		jns[3] = 8
		jns[6] = "wzife.wd2"
		jns[7] = 0xA209C3C2
		jns[8] = 0xA209C3C2
	elseif jn == "额外能力(五庄观)" then
		jns[1] = "学习之后，伤害+%5 防御+%15 灵力+%15 法防+%15 速度+%5"
		jns[3] = 8
		jns[6] = "wzife.wd2"
		jns[7] = 0xA209C3C2
		jns[8] = 0xA209C3C2
	elseif jn == "额外能力(花果山)" then
		jns[1] = "学习之后，伤害+%5 防御+%15 灵力+%15 法防+%15 速度+%5"
		jns[3] = 8
		jns[6] = "wzife.wd2"
		jns[7] = 0xA209C3C2
		jns[8] = 0xA209C3C2
	elseif jn == "额外能力(普陀山)" then
		jns[1] = "学习之后，伤害+%5 防御+%15 灵力+%15 法防+%15 速度+%5"
		jns[3] = 8
		jns[6] = "wzife.wd2"
		jns[7] = 0xA209C3C2
		jns[8] = 0xA209C3C2
	elseif jn == "额外能力(龙宫)" then
		jns[1] = "学习之后，伤害+%5 防御+%15 灵力+%15 法防+%15 速度+%5"
		jns[3] = 8
		jns[6] = "wzife.wd2"
		jns[7] = 0xA209C3C2
		jns[8] = 0xA209C3C2
	elseif jn == "额外能力(天宫)" then
		jns[1] = "学习之后，伤害+%5 防御+%15 灵力+%15 法防+%15 速度+%5"
		jns[3] = 8
		jns[6] = "wzife.wd2"
		jns[7] = 0xA209C3C2
